...
public class SolCcdCaseProgressTests extends IntegrationTestBase  {
    ...
    public void shouldTransformCaseCorrectlyWhenFailQa() {
        final String response = postCwJson("caseprogress/06-caseStopped.json", CASE_FAIL_QA_URL);
        final JsonPath jsonPath = JsonPath.from(response);
        final String taskList = jsonPath.get("data.taskList");
        ...
        String expectedHtml = fileSystemResourceService
            .getFileFromResourceAsString("json/caseprogress/06a-caseStoppedExpectedHMTL");
