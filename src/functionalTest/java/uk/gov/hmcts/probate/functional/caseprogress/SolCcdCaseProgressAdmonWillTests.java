...
public class SolCcdCaseProgressAdmonWillTests extends IntegrationTestBase {
    ...
    public void shouldTransformCaseCreatedStateCorrectlyOnPrinting() {
        ...
        final String expected = "<div class=\"govuk-grid-row\"><div class=\"govuk-grid-column-two-thirds\">\n"
            ...
            + " legal statement and declaration</li><li>the original will</li><li>the inheritance tax form IHT205</li>"
    ...
    public void shouldTransformCaseCorrectlyWhenCaseMatchingReadyToIssue() {
        ...
        final String expected = "<div class=\"govuk-grid-row\"><div class=\"govuk-"
            ...
            + "<ul><li>the printed <a href=\"#\" target=\"_blank\" rel=\"noopener noreferrer\""
            + " class=\"govuk-link\">coversheet</a> or your reference number"
            + " 1528365719153338 written on a sheet of paper</li><li>a photocopy of the signed legal statement"
