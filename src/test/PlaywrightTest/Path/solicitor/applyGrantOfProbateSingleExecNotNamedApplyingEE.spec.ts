...
test.describe("Solicitor - Apply Grant of probate Single Executor Excepted Estates (not named, applying)", () => {
  test("Solicitor - Apply Grant of probate Single Executor Excepted Estates (not named, applying) @edge", async ({
    basePage,
    signInPage,
    createCasePage,
    solCreateCasePage,
    ...
    await basePage.seeUpdatesOnCase(testInfo, caseRef, applicantDetailsTabConfig, 'SolicitorMainApplicantAndExecutor', applyProbateConfig);
