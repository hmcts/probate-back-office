...
module.exports = async function (uniqueDeceasedSuffix) {
    ...
    assert (formHtml.includes(caseProgressConfig.deceasedFirstname + uniqueDeceasedSuffix));
    assert (formHtml.includes(caseProgressConfig.deceasedSurname + uniqueDeceasedSuffix));
