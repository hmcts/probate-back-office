...
module.exports = async function (caseRef, useWaitInUrl = true, caseType) {
    ...
    /*
    Commenting this as find case search not working consistently due to the xui web app loading performance issues. If required, this code will be uncommented once the xui slowness issues resolved and delete the newly added code.
     */
