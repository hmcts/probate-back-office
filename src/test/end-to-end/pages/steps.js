...
module.exports = function () {
    return actor({
        ...
        cwCreateSolsGoPPage1: steps.createGrantOfProbateSolicitor.page1,
        cwCreateSolsGoPPage2: steps.createGrantOfProbateSolicitor.page2,
        cwCreateSolsGoPPage3: steps.createGrantOfProbateSolicitor.page3,
        cwCreateSolsGoPPage4: steps.createGrantOfProbateSolicitor.page4,
        cwCreateSolsGoPPage5: steps.createGrantOfProbateSolicitor.page5,
        cwCreateSolsGoPPage6: steps.createGrantOfProbateSolicitor.page6,
        cwCreateSolsGoPPage7: steps.createGrantOfProbateSolicitor.page7,
        cwCreateSolsGoPPage8: steps.createGrantOfProbateSolicitor.page8,
        cwCreateSolsGoPPage9: steps.createGrantOfProbateSolicitor.page9,
