...
module.exports = function () {
    return actor({
        ...
        caseProgressPage33: steps.caseProgress.page33,  
        caseProgressPage34: steps.caseProgress.page34,  
        caseProgressPage35: steps.caseProgress.page35,  
        caseProgressPage36: steps.caseProgress.page36,  
        caseProgressPage37: steps.caseProgress.page37,  
        caseProgressPage38: steps.caseProgress.page38,  
        caseProgressPage39: steps.caseProgress.page39,  
        caseProgressPage40: steps.caseProgress.page40,  
        caseProgressPage41: steps.caseProgress.page41,  
        caseProgressPage42: steps.caseProgress.page42,  
        caseProgressPage43: steps.caseProgress.page43,  
        caseProgressPage44: steps.caseProgress.page44,  
        caseProgressPage45: steps.caseProgress.page45,  
        caseProgressPage46: steps.caseProgress.page46,  
        caseProgressPage47: steps.caseProgress.page47,  
        caseProgressPage48: steps.caseProgress.page48,  
        caseProgressPage49: steps.caseProgress.page49,  
        caseProgressPage50: steps.caseProgress.page50,  
        caseProgressPage51: steps.caseProgress.page51,  
        caseProgressPage52: steps.caseProgress.page52,  
