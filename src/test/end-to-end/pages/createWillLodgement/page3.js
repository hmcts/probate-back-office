...
module.exports = function (crud) {
    ...
    if (crud === 'create') {
        ...
        I.fillField('#executorAddress__AddressLine1', createWillLodgementConfig.address_line1);
        I.fillField('#executorAddress__AddressLine2', createWillLodgementConfig.address_line2);
        I.fillField('#executorAddress__AddressLine3', createWillLodgementConfig.address_line3);
        I.fillField('#executorAddress__PostTown', createWillLodgementConfig.address_town);
        I.fillField('#executorAddress__County', createWillLodgementConfig.address_county);
        I.fillField('#executorAddress__PostCode', createWillLodgementConfig.address_postcode);
        I.fillField('#executorAddress__Country', createWillLodgementConfig.address_country);
        ...
        I.fillField(`#additionalExecutorList_${index}_executorAddress__AddressLine1`, createWillLodgementConfig.address_line1);
        I.fillField(`#additionalExecutorList_${index}_executorAddress__AddressLine2`, createWillLodgementConfig.address_line2);
        I.fillField(`#additionalExecutorList_${index}_executorAddress__AddressLine3`, createWillLodgementConfig.address_line3);
        I.fillField(`#additionalExecutorList_${index}_executorAddress__PostTown`, createWillLodgementConfig.address_town);
        I.fillField(`#additionalExecutorList_${index}_executorAddress__County`, createWillLodgementConfig.address_county);
        I.fillField(`#additionalExecutorList_${index}_executorAddress__PostCode`, createWillLodgementConfig.address_postcode);
        I.fillField(`#additionalExecutorList_${index}_executorAddress__Country`, createWillLodgementConfig.address_country);
