...
module.exports = async function (crud, unique_deceased_user) {
    ...
    if (crud === 'create') {
        ...
        await I.fillField('#boDeceasedTitle', createGrantOfProbateConfig.page4_bo_deceasedTitle);
        await I.fillField('#deceasedForenames', createGrantOfProbateConfig.page4_deceasedForenames + '_' + unique_deceased_user);
        await I.fillField('#deceasedSurname', createGrantOfProbateConfig.page4_deceasedSurname + '_' + unique_deceased_user);
        ...
        await I.selectOption('#dateOfDeathType', createGrantOfProbateConfig.page4_dateOfDeathType);
        ...
        await I.selectOption('#deceasedMaritalStatus', createGrantOfProbateConfig.page4_deceasedMaritalStatus);
