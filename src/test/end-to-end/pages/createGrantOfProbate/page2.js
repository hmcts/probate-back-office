...
module.exports = async function (crud) {
    ...
    if (crud === 'create') {
        ...
        await I.waitForVisible({css: '#primaryApplicantAddress__detailAddressAddressLine1'});
        await I.fillField('#primaryApplicantAddress__detailAddressAddressLine1', createGrantOfProbateConfig.address_line1);
        await I.fillField('#primaryApplicantAddress__detailAddressAddressLine2', createGrantOfProbateConfig.address_line2);
        await I.fillField('#primaryApplicantAddress__detailAddressAddressLine3', createGrantOfProbateConfig.address_line3);
        await I.fillField('#primaryApplicantAddress__detailAddressPostTown', createGrantOfProbateConfig.address_town);
        await I.fillField('#primaryApplicantAddress__detailAddressCounty', createGrantOfProbateConfig.address_county);
        await I.fillField('#primaryApplicantAddress__detailAddressPostCode', createGrantOfProbateConfig.address_postcode);
        await I.fillField('#primaryApplicantAddress__detailAddressCountry', createGrantOfProbateConfig.address_country);
    }
