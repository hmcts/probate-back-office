...
module.exports = async function (crud, createGrantOfProbateConfig) {
    ...
    if (crud === 'create') {
        ...
        await I.click({css: `#paperForm_${createGrantOfProbateConfig.page1_paperForm}`});
    ...
    if (crud === 'update') {
        ...
        await I.waitForEnabled({css: '#caseHandedOffToLegacySite_No'});
        await I.click('#caseHandedOffToLegacySite_No');
    }
