...
module.exports = async function (crud, createGrantOfProbateConfig) {
    ...
    if (crud === 'create') {
        ...
        if (tct === 'TCTTrustCorpResWithApp') {
            ...
            await I.fillField('#trustCorpAddress__detailAdressAddressLine1', createGrantOfProbateConfig.page3_trustAddress_line1);
            await I.fillField('#trustCorpAddress__detailAdressAddressLine2', createGrantOfProbateConfig.page3_trustAddress_line2);
            await I.fillField('#trustCorpAddress__detailAdressPostTown', createGrantOfProbateConfig.page3_trustAddress_town);
            await I.fillField('#trustCorpAddress__detailAdressPostCode', createGrantOfProbateConfig.page3_trustAddress_postcode);
            await I.fillField('#trustCorpAddress__detailAdressCountry', createGrantOfProbateConfig.page3_trustAddress_country);
            ...
            await I.scrollTo('#addressOfSucceededFirm__detailAdressAddressLine1');
            await I.fillField('#addressOfSucceededFirm__detailAdressAddressLine1', createGrantOfProbateConfig.page3_succeededAddress_line1);
            await I.fillField('#addressOfSucceededFirm__detailAdressAddressLine2', createGrantOfProbateConfig.page3_succeededAddress_line2);
            await I.fillField('#addressOfSucceededFirm__detailAdressPostTown', createGrantOfProbateConfig.page3_succeededAddress_town);
            await I.fillField('#addressOfSucceededFirm__detailAdressPostCode', createGrantOfProbateConfig.page3_succeededAddress_postcode);
            await I.fillField('#addressOfSucceededFirm__detailAdressCountry', createGrantOfProbateConfig.page3_succeededAddress_country);
