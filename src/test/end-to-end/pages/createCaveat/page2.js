...
module.exports = function (crud, unique_deceased_user) {
    ...
    if (crud === 'create') {
        ...
        I.fillField('#deceasedForenames', createCaveatConfig.page2_forenames+unique_deceased_user);
        I.fillField('#deceasedSurname', createCaveatConfig.page2_surname+unique_deceased_user);
    ...
    if (crud === 'update') {
        ...
        I.fillField('#deceasedForenames', createCaveatConfig.page2_forenames_update+unique_deceased_user);
        I.fillField('#deceasedSurname', createCaveatConfig.page2_surname_update+unique_deceased_user);
