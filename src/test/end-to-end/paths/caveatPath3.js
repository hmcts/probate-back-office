...
const caveatExpiredSummaryConfig = require('src/test/end-to-end/pages/eventSummary/caveat/caveatExpiredSummaryConfig');
...
Scenario('Caveat Workflow - E2E Test 03 - Caveat for a Personal Applicant - Raise a caveat -> Caveat not matched -> Caveat expired', async function (I) {
    ...
    I.chooseNextStep(nextStepName);
    I.enterEventSummary(caseRef, caveatExpiredSummaryConfig);
    endState = 'Caveat closed';
    I.seeCaseDetails(caseRef, historyTabConfig, caveatExpiredSummaryConfig, nextStepName, endState);
