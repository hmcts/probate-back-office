...
const documentUploadSolTabConfigBilingual = require('src/test/end-to-end/pages/caseDetails/grantOfProbate/documentUploadSolTabConfigBilingual');
...
Scenario(scenarioName, async function ({I}) {
    ...
    try {
        ...
        await I.seeTabDetailsBilingual(caseRef, documentUploadSolTabConfigBilingual, caseProgressConfig);
