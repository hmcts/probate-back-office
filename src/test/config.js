...
module.exports = {
    ...
    CaseDetailsDelayDefault:
        process.env.E2E_AUTO_DELAY_ENABLED === 'true' ? 1 : 0,
    ...
    CaseMatchesInitialDelay:
        process.env.E2E_AUTO_DELAY_ENABLED === 'true' ? 1 : 0.25,
    CaseMatchesLocateRemoveButtonDelay:
        process.env.E2E_AUTO_DELAY_ENABLED === 'true' ? 0.5 : 0.25,
    CaseMatchesAddNewButtonClickDelay:
        process.env.E2E_AUTO_DELAY_ENABLED === 'true' ? 0.5 : 0,
    ...
    DocumentUploadDelay:
        process.env.E2E_AUTO_DELAY_ENABLED === 'true' ? 1 : 0.5,
