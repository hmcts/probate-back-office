module.exports = {
    ...
    SignOutDelayDefault: process.env.E2E_AUTO_DELAY_ENABLED === 'true' ? 0 : 0,
    SignInDelay: process.env.E2E_AUTO_DELAY_ENABLED === 'true' ? 0 : 0,
    SignInDelayDefault: process.env.E2E_AUTO_DELAY_ENABLED === 'true' ? 0 : 0,
    RejectCookies: false,
    RejectCookieDelay: process.env.E2E_AUTO_DELAY_ENABLED === 'true' ? 0 : 0,
    ...
    CaseMatchesInitialDelay: process.env.E2E_AUTO_DELAY_ENABLED === 'true' ? 0 : 0,
    ...
    CaseworkerGoButtonClickDelay: process.env.E2E_AUTO_DELAY_ENABLED === 'true' ? 0 : 0,
    CaseProgressTabCheckDelay: process.env.E2E_AUTO_DELAY_ENABLED === 'true' ? 0 : 0,
    CaseProgressClickSelectFillDelay: process.env.E2E_AUTO_DELAY_ENABLED === 'true' ? 0 : 0,
    CaseProgressClickGoButtonInitialDelay: process.env.E2E_AUTO_DELAY_ENABLED === 'true' ? 0 : 0,
    CaseProgressContinueWithoutChangingDelay: process.env.E2E_AUTO_DELAY_ENABLED === 'true' ? 0 : 0,
    CaseworkerCaseNavigateDelay: process.env.E2E_AUTO_DELAY_ENABLED === 'true' ? 0 : 0,
    CaseProgressSolicitorDetailsDelay: process.env.E2E_AUTO_DELAY_ENABLED === 'true' ? 0 : 0,
    CaseProgressSubmitConfirmationDelay: process.env.E2E_AUTO_DELAY_ENABLED === 'true' ? 0 : 0,
    CreateCaseDelay: process.env.E2E_AUTO_DELAY_ENABLED === 'true' ? 0 : 0,
    DocumentUploadDelay: process.env.E2E_AUTO_DELAY_ENABLED === 'true' ? 1 : 0.5,
    EventSummaryDelay: process.env.E2E_AUTO_DELAY_ENABLED === 'true' ? 0 : 0,
    GetCaseRefFromUrlDelay: process.env.E2E_AUTO_DELAY_ENABLED === 'true' ? 0 : 0,
    ...
    CheckYourAnswersDelay: process.env.E2E_AUTO_DELAY_ENABLED === 'true' ? 0.5 : 0.5
};
