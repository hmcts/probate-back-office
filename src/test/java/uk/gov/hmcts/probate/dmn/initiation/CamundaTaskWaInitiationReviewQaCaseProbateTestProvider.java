...
public class CamundaTaskWaInitiationReviewQaCaseProbateTestProvider implements ArgumentsProvider {

    @Override
    public Stream<? extends Arguments> provideArguments(ExtensionContext context) {

        Map<String,Object> reviewQaCaseProbateTaskAttributes = Map.of(
                "taskId", REVIEW_QA_CASE_PROBATE,
                "name", REVIEW_QA_CASE_PROBATE_TASK_TYPE_NAME,
        ...
        return Stream.of(
                Arguments.of(
                        ...
                        BO_CASE_QA_STATE,
                        additionalData(false, GOP_CASE_TYPE, false, emptyList(), false),
                ...
                Arguments.of(
                        BO_SELECT_FOR_QA_EVENT,
                        BO_CASE_QA_STATE,
                        additionalData(true, GOP_CASE_TYPE, false, emptyList(), false),
                        emptyList()
                ),
