...
import static uk.gov.hmcts.probate.dmnutils.TaskAttributeConstants.EXAMINE_FIAT_WILL_CASE_PRINTED_SKILL_CODE;
import static uk.gov.hmcts.probate.dmnutils.TaskAttributeConstants.EXAMINE_FOREIGN_DOMICILE_CASE_PRINTED;
import static uk.gov.hmcts.probate.dmnutils.TaskAttributeConstants.EXAMINE_FOREIGN_DOMICILE_CASE_PRINTED_SKILL_CODE;
...
import static uk.gov.hmcts.probate.dmnutils.TaskAttributeConstants.EXAMINE_INCAPACITY_UNDER_RULE_35_CASE_PRINTED_SKILL_CODE;
    ...
    static Stream<Arguments> scenarioProvider() {
        return Stream.of(
                ...
                Arguments.of(
                        ...
                        DUMMY_CASE_DATA,
                        getCtscExaminePermissions(INTESTACY_EXAMINE_SKILL_CODE)
                ),
                Arguments.of(
                ...
                Arguments.of(
                        ...
                        DUMMY_CASE_DATA,
                        getCtscExaminePermissions(EXAMINE_FIAT_WILL_CASE_PRINTED_SKILL_CODE)
                ),
                Arguments.of(
                        EXAMINE_FOREIGN_DOMICILE_CASE_PRINTED,
                        DUMMY_CASE_DATA,
                        getCtscExaminePermissions(EXAMINE_FOREIGN_DOMICILE_CASE_PRINTED_SKILL_CODE)
                ),
                Arguments.of(
                        EXAMINE_INCAPACITY_UNDER_RULE_35_CASE_PRINTED,
                        DUMMY_CASE_DATA,
                        getCtscExaminePermissions(EXAMINE_INCAPACITY_UNDER_RULE_35_CASE_PRINTED_SKILL_CODE)
                )
        );
    }
