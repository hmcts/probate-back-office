...
public class EmailAddressExecutorsApplyingValidationRuleTest {
    ...
    public void shouldThrowApplyingExecEmailIsEmpty() {
        ...
        Assertions.assertThatThrownBy(() -> {
            emailAddressExecutorsApplyingValidationRule.validateEmails(caseDetailsEmpty);
        })
    ...
    public void shouldThrowApplyingExecEmailIsNull() {
        ...
        Assertions.assertThatThrownBy(() -> {
            emailAddressExecutorsApplyingValidationRule.validateEmails(caseDetailsNull);
        })
                .isInstanceOf(BusinessValidationException.class)
    ...
    @Test
    public void shouldThrowApplyingExecEmailIsNotEmpty() {
