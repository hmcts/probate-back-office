...
public class EmailAddressPrimaryApplicantValidationRuleTest {
    ...
    public void shouldThrowApplyingExecEmailIsEmpty() {
        ...
        Assertions.assertThatThrownBy(() -> {
            emailAddressPrimaryApplicantValidationRule.validate(caseDetailsEmptyEmail);
        })
    ...
    public void shouldThrowApplyingExecEmailIsInvalid1() {
        ...
        Assertions.assertThatThrownBy(() -> {
            emailAddressPrimaryApplicantValidationRule.validate(caseDetailsEmailInvalid);
        })
                .isInstanceOf(BusinessValidationException.class)
                .hasMessage("Primary applicant's email does not meet the criteria for case id 12345678987654321");
    }
