...
import static uk.gov.hmcts.probate.validator.IHTGrossNetEstateValidationRule.IHT_ESTATE_NET_GREATER_THAN_GROSS;

@RunWith(MockitoJUnitRunner.class)
public class IHTGrossNetEstateValidationRuleTest {
    ...
    private IHTGrossNetEstateValidationRule underTest;
    ...
    public void setUp() {
        ...
        this.underTest = new IHTGrossNetEstateValidationRule(businessValidationMessageService);
    ...
    public void testValidateFailureWhenNetHigherThanGross() {
        ...
        verify(businessValidationMessageService, times(1)).generateError(BUSINESS_ERROR,
