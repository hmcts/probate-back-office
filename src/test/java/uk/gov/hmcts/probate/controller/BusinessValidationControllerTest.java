...
public class BusinessValidationControllerTest {
    ...
    public void shouldValidateWithSolicitorIHTFormIsNullError() throws Exception {
        ...
        mockMvc.perform(post(SOLS_VALIDATE_URL).content(json).contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void shouldSuccesfullyGenerateProbateDeclaration() throws Exception {
        ...
        mockMvc.perform(post(SOLS_VALIDATE_PROBATE_URL).content(json).contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void shouldSuccesfullyGenerateIntestacyDeclaration() throws Exception {
        ...
        when(pdfManagementService.generateAndUpload(any(CallbackRequest.class), any(DocumentType.class)))
                .thenReturn(probateDocument);
        mockMvc.perform(post(SOLS_VALIDATE_INTESTACY_URL).content(json).contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void shouldSuccesfullyGenerateAdmonWillDeclaration() throws Exception {
        ...
        when(pdfManagementService.generateAndUpload(any(CallbackRequest.class), any(DocumentType.class)))
                .thenReturn(probateDocument);
        mockMvc.perform(post(SOLS_VALIDATE_ADMON_URL).content(json).contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    private void validateDodIsNullError(String url) throws Exception {
        ...
        String json = OBJECT_MAPPER.writeValueAsString(callbackRequest);
        mockMvc.perform(post(url).content(json).contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isBadRequest())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.fieldErrors[0].param").value("callbackRequest"))
    ...
    public void shouldReturnAliasNameTransformed() throws Exception {
        ...
        mockMvc.perform(post(CASE_PRINTED).content(solicitorPayload).contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE));
    }
    ...
    public void shouldReturnCheckListValidateSuccessfulQAState() throws Exception {
        ...
        mockMvc.perform(post(CASE_CHCEKLIST_URL).content(solicitorPayload).contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isOk())
    ...
    public void shouldReturnPaperForm() throws Exception {
        ...
        mockMvc.perform(post(PAPER_FORM_URL).content(caseCreatorJson).contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE));
    }
    ...
    public void shouldReturnScannedDocumentsAndStartAwaitingDocumentationPeriod() throws Exception {
        ...
        mockMvc.perform(post(CASE_PRINTED).content(scannedDocumentsJson).contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void shouldSetStateToCaseCreatedAfterResolveStateChoice() throws Exception {
        ...
        mockMvc.perform(post(RESOLVE_STOP_URL).content(solicitorPayload).contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isOk())
