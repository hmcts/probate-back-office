...
class Dtspb5472GorRollbackTest {

    Dtspb5472GorRollback underTest;

    @BeforeEach
    void setUp() {
        underTest = new Dtspb5472GorRollback();
    }

    @Test
    void shouldNullPrimaryApplicantAdoptedIn() {
        ...
        assertAll(
                () -> verify(caseData).clearPrimaryApplicantAdoptedIn(),
