...
public class TaskListUpdateServiceTest {
    ...
    private ResponseCaseDataBuilder builder = ResponseCaseData.builder();
    ...
    public void shouldBuildCaseProgressHtmlCorrectly_CaseCreated() {
        ...
        String expectedCaseProgressCaseCreatedHtml = "<div class=\"govuk-grid-row\">"
            ...
            + "\n"
            + "<div class=\"govuk-grid-row\"><div class=\"govuk-grid-column-two-thirds\"><p class=\"govuk-body-s\">"
            + "Add application details</p></div><div class=\"govuk-grid-column-one-third\">"
            + "<p><img align=\"right\" width=\"114px\" "
            + "height=\"31px\" src=\"https://raw.githubusercontent.com/hmcts/probate-back-office/"
            + TaskState.CODE_BRANCH
            + "/src/main/resources/statusImages/completed.png\" alt=\"COMPLETED\" title=\"COMPLETED\" /></p>\n"
            + "</div></div>\n"
            ...
            + "\n"
            + "<div class=\"govuk-grid-row\"><div class=\"govuk-grid-column-two-thirds\"><p class=\"govuk-body-s\">"
            + "Review and sign legal statement and submit application</p></div><div "
            + "class=\"govuk-grid-column-one-third\"><p>"
            ...
            + "then sign and "
            + "submit your application.</font></p></div><div class=\"govuk-grid-column-one-third\">"
            + "&nbsp;</div></div>\n"
            + "<hr class=\"govuk-section-break govuk-section-break--m govuk-section-break--visible\">\n"
            + "\n"
            + "<div class=\"govuk-grid-row\"><div class=\"govuk-grid-column-two-thirds\"><p class=\"govuk-body-s\">"
            ...
            + "rel=\"noopener noreferrer\" class=\"govuk-link\">coversheet</a> or your reference number 1"
            ...
            + "\n"
            + "<div class=\"govuk-grid-row\"><div class=\"govuk-grid-column-two-thirds\">"
            + "<p class=\"govuk-body-s\">Examine application</p>"
            + "</div><div class=\"govuk-grid-column-one-third\"></div></div>\n"
            + "<div class=\"govuk-grid-row\"><div class=\"govuk-grid-column-two-thirds\"><p class=\"govuk-body-s\">"
            + "<font color=\"#505a5f\">"
            ...
            + "<div class=\"govuk-grid-row\"><div class=\"govuk-grid-column-two-thirds\"><p class=\"govuk-body-s\">"
            + "<font color=\"#505a5f\">The grant will be delivered in the post a few days "
            + "after issuing.</font></p></div>"
            + "<div class=\"govuk-grid-column-one-third\">&nbsp;</div></div>\n"
            + "<hr class=\"govuk-section-break govuk-section-break--m govuk-section-break--visible\">\n"
            + "\n</div>\n</div>\n";
    ...
    public void shouldBuildCaseProgressHtmlCorrectly_BOExamining() {
        ...
        String expectedCaseProgressCaseCreatedHtml =
            ...
            + "\n"
            + "<div class=\"govuk-grid-row\"><div class=\"govuk-grid-column-two-thirds\"><p class=\"govuk-body-s\">"
            + "Add deceased details</p></div><div class=\"govuk-grid-column-one-third\"><p>"
            + "<img align=\"right\" width=\"114px\" height=\"31px\" "
            + "src=\"https://raw.githubusercontent.com/hmcts/probate-back-office/"
            + TaskState.CODE_BRANCH
            + "/src/main/resources/statusImages/completed.png\" alt=\"COMPLETED\" title=\"COMPLETED\" /></p>\n"
            ...
            + "\n"
            + "<div class=\"govuk-grid-row\"><div class=\"govuk-grid-column-two-thirds\"><p class=\"govuk-body-s\">"
            + "Add application details</p></div><div class=\"govuk-grid-column-one-third\"><p>"
            + "<img align=\"right\" width=\"114px\" "
            + "height=\"31px\" src=\"https://raw.githubusercontent.com/hmcts/probate-back-office/"
            + TaskState.CODE_BRANCH
            + "/src/main/resources/statusImages/completed.png\" alt=\"COMPLETED\" title=\"COMPLETED\" /></p>\n"
            ...
            + "  </summary>\n"
            + "  <div class=\"govuk-details__text\">\n"
            + "    You now need to send us<br/><ul><li>the printed coversheet or your reference number 1 written on a"
            ...
            + "\n"
            + "<div class=\"govuk-grid-row\"><div class=\"govuk-grid-column-two-thirds\"><p class=\"govuk-body-s\">"
            + "Authenticate documents</p></div><div class=\"govuk-grid-column-one-third\"><p>"
            + "<img align=\"right\" width=\"114px\" height=\"31px\" src=\"https://raw.githubusercontent.com"
            + "/hmcts/probate-back-office/"
            + TaskState.CODE_BRANCH
            + "/src/main/resources/statusImages/completed.png\" alt=\"COMPLETED\" title=\"COMPLETED\" /></p>\n"
            + "</div></div>\n"
            + "<div class=\"govuk-grid-row\"><div class=\"govuk-grid-column-two-thirds\"><p class=\"govuk-body-s\">"
            + "<font color=\"#505a5f\">We will authenticate your documents and match them with "
            + "your application.</font></p></div>"
            + "<div class=\"govuk-grid-column-one-third\">&nbsp;</div></div>\n"
            + "<hr class=\"govuk-section-break govuk-section-break--m govuk-section-break--visible\">\n"
            + "\n"
            + "<div class=\"govuk-grid-row\"><div class=\"govuk-grid-column-two-thirds\"><p class=\"govuk-body-s\">"
            + "Examine application</p></div><div class=\"govuk-grid-column-one-third\"><p>"
            ...
            + "</div></div>\n"
            + "<div class=\"govuk-grid-row\"><div class=\"govuk-grid-column-two-thirds\"><p class=\"govuk-body-s\">"
            + "<font color=\"#505a5f\">We review your application for incomplete information or problems and validate "
            + "it against other "
    ...
    public void shouldBuildCaseProgressHtmlCorrectly_BORegistrarEscalation() {
        ...
        assertTrue(result.getTaskList().contains("Case escalated to a Registrar"));
    }
}
