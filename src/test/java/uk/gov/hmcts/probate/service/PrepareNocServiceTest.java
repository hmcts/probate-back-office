...
class PrepareNocServiceTest {
    ...
    public void testApplyDecision() {
        ...
        FindUsersByOrganisationResponse organisationResponse = new FindUsersByOrganisationResponse();
        organisationResponse.setOrganisationIdentifier("123");
        when(organisationsRetrievalService.findUserOrganisation(anyString(), anyString()))
