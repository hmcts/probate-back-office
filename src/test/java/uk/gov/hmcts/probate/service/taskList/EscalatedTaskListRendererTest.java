...
public class EscalatedTaskListRendererTest {
    ...
    public void shouldRenderStoppedCaseProgressHtmlCorrectly() {
        ...
        final String expectedHtml = "<div class=\"width-50\">\n" +
                ...
                "<p class=\"govuk-body-s\">The case will be reviewed by a Registrar and you will be notified by email if we need any information from you to progress the case.</p>\n" +
                ...
                "\n" +
                "<a href=\"mailto:contactprobate@justice.gov.uk\" class=\"govuk-link\">contactprobate@justice.gov.uk</a><p class=\"govuk-body-s\">We aim to respond within 10 working days</p>\n" +
                "\n" +
                "</div>";
