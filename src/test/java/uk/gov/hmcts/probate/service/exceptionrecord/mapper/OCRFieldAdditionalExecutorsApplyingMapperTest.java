...
public class OCRFieldAdditionalExecutorsApplyingMapperTest {
    ...
    public void testAdditionalExecutorApplying() {
        ...
        assertEquals(EXECUTOR_APPLYING_1_ADDRESS_LINE1,
            response.get(0).getValue().getApplyingExecutorAddress().getAddressLine1());
    ...
    public void testTwoAdditionalExecutorApplying() {
        ...
        assertEquals(EXECUTOR_APPLYING_2_ADDRESS_LINE1,
            response.get(1).getValue().getApplyingExecutorAddress().getAddressLine1());
