...
class DefaultTaskListRendererTest {
    ...
    private final String expectedHtml = "<div class=\"govuk-grid-row\"><div class=\"govuk-grid-column-two-thirds\">\n"
        ...
        + "<div class=\"govuk-grid-row\"><div class=\"govuk-grid-column-two-thirds\"><p class=\"govuk-body-s\"><font "
        + "color=\"#505a5f\">The grant will be delivered by post within 10 working days after it has been issued."
        + "</font></p><p class=\"govuk-body-s\"><font color=\"#505a5f\">Bydd y grant yn cael ei anfon yn y "
        + "post ychydig ddyddiau ar ôl ei gyhoeddi.</font></p>"
    ...
    private final String expectedHtml1 = "<div class=\"govuk-grid-row\"><div class=\"govuk-grid-column-two-thirds\">\n"
        ...
        + "<div class=\"govuk-grid-row\"><div class=\"govuk-grid-column-two-thirds\"><p class=\"govuk-body-s\"><font "
        + "color=\"#505a5f\">The grant will be delivered by post within 10 working days after it has been issued."
        + "</font></p></font></p><p class=\"govuk-body-s\"><font color=\"#505a5f\">Bydd y grant yn cael ei anfon yn "
        + "y post ychydig ddyddiau ar ôl ei gyhoeddi.</font></p>"
        + "</div><div class=\"govuk-grid-column-one-third\">&nbsp;</div></div>\n"
        + "<hr class=\"govuk-section-break govuk-section-break--m govuk-section-break--visible\">\n"
        + "\n</div>\n</div>\n";
    ...
    void shouldRenderDefaultCaseProgressHtmlCorrectly() {
        ...
        when(taskStateRendererMock.renderByReplace(TaskListState.TL_STATE_EXAMINE_APPLICATION,
            "<div class=\"govuk-grid-row\"><div class=\"govuk-grid-column-two-thirds\">\n"
                ...
                + "<div class=\"govuk-grid-row\"><div class=\"govuk-grid-column-two-thirds\"><p "
                + "class=\"govuk-body-s\"><font color=\"#505a5f\">These steps are to be completed by the Probate "
                + "practitioner.</font></p><p class=\"govuk-body-s\"><font color=\"#505a5f\">"
                + "Dylai'r camau hyn gael eu cwblhau gan yr ymarferydd profiant.</font></p></div>"
                ...
                + "</div><div class=\"govuk-grid-column-one-third\"><status-paymentMade/><status-paymentMadeWelsh/>"
                + "</div></div>\n"
                + "<hr class=\"govuk-section-break govuk-section-break--m govuk-section-break--visible\">\n"
                + "\n"
                + "<div class=\"govuk-grid-row\">"
                    + "<div class=\"govuk-grid-column-two-thirds\">"
                    +   "<p class=\"govuk-body-s\">Send documents</p>"
                    + "</div>"
                ...
                + "<div class=\"govuk-grid-row\">"
                    + "<div class=\"govuk-grid-column-two-thirds\">"
                    +   "<p class=\"govuk-body-s\">Anfon dogfennau</p>"
                    + "</div>"
                    + "<div class=\"govuk-grid-column-one-third\">"
                ...
                + "</div><div class=\"govuk-grid-column-one-third\">&nbsp;</div></div>\n"
                + "<div class=\"govuk-grid-row\"><div class=\"govuk-grid-column-two-thirds\">"
                + "<p class=\"govuk-body-s\"><font color=\"#505a5f\">Your application will update through any of these "
                + "case states as it is reviewed by our team:</font></p>"
                + "</div><div class=\"govuk-grid-column-one-third\">&nbsp;</div></div>\n"
                + "<ul class=\"govuk-list govuk-list--bullet\">\n"
                + "<li>Examining</li>\n"
                + "<li>Case Matching</li>\n"
                ...
                + "<div class=\"govuk-grid-row\"><div class=\"govuk-grid-column-two-thirds\">"
                + "<p class=\"govuk-body-s\"><font color=\"#505a5f\">The grant will be delivered by post "
                + "within 10 working days after it has been issued.</font></p>"
                + "</div><div class=\"govuk-grid-column-one-third\">&nbsp;</div></div>\n"
                + "<div class=\"govuk-grid-row\"><div class=\"govuk-grid-column-two-thirds\">"
                + "<p class=\"govuk-body-s\"><issueGrantLinkWelsh/></p>"
                + "</div><div class=\"govuk-grid-column-one-third\"><status-issueGrantWelsh/></div></div>\n"
                + "<div class=\"govuk-grid-row\"><div class=\"govuk-grid-column-two-thirds\">"
                + "<p class=\"govuk-body-s\"><font color=\"#505a5f\">Bydd y grant yn cael ei anfon yn y post o "
                + "fewn 10 diwrnod gwaith ar ôl iddo gael ei gyflwyno.</font></p>"
                + "</div><div class=\"govuk-grid-column-one-third\">&nbsp;</div></div>\n"
                + "<hr class=\"govuk-section-break govuk-section-break--m govuk-section-break--visible\">\n"
                + "\n"
                + "</div>\n"
    ...
    void shouldRenderCaseProgressHtmlCorrectlyForNoDocs() {
        ...
        when(taskStateRendererMock.renderByReplace(TaskListState.TL_STATE_EXAMINE_APPLICATION,
            "<div class=\"govuk-grid-row\"><div class=\"govuk-grid-column-two-thirds\">\n"
                ...
                + "o fewn 10 diwrnod gwaith ar ôl iddo gael ei gyflwyno.</font></p>"
                + "</div><div class=\"govuk-grid-column-one-third\">&nbsp;</div></div>\n"
                + "<hr class=\"govuk-section-break govuk-section-break--m govuk-section-break--visible\">\n"
                + "\n"
                + "</div>\n"
