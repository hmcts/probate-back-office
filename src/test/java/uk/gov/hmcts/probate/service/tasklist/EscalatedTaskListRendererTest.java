    ...
    void shouldRenderStoppedCaseProgressHtmlCorrectly() {
        ...
        final String expectedHtml = "<div class=\"width-50\">\n\n"
            ...
            + "information from you to progress the case.</p>\n"
                + "<p class=\"govuk-body-s\">Bydd yr achos yn cael ei adolygu gan Gofrestrydd a byddwch yn cael "
                + "eich hysbysu drwy e-bost os bydd arnom angen unrhyw wybodaeth "
                + "gennych i symud yr achos yn ei flaen.</p>\n"
            ...
            + "<p class=\"govuk-body-s\">Dim ond os yw eich achos wedi'i gyfeirio ers 6 wythnos neu fwy y"
            + " dylech gysylltu â staff y CTSC ac nad ydych wedi cael unrhyw ohebiaeth ers hynny.</p>\n\n\n"
