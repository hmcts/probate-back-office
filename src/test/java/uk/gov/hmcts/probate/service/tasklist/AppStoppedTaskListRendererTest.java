...
public class AppStoppedTaskListRendererTest {
    ...
    public void shouldRenderStoppedCaseProgressHtmlCorrectly() {
        ...
        final String expected = "<div class=\"width-50\">\n"
            ...
            + "\n"
            + "<p class=\"govuk-body-s\">This application has been stopped. Based on the information you have entered, "
            ...
            + "<a href=\"https://www.gov.uk/government/collections/probate-forms\" target=\"_blank\" rel=\"noopener noreferrer\" "
            + "class=\"govuk-link\">paper form</a>.</p>\n"
            + "<p class=\"govuk-body-s\"><a href=\"https://www.gov.uk/guidance/probate-paper-applications-for-legal-professionals\" "
            + "target=\"_blank\" rel=\"noopener noreferrer\" class=\"govuk-link\">Guidance on exemptions, conditions and when "
            + "applications must be submitted by paper.</a></p>\n"
            + "<p class=\"govuk-body-s\">If having read this guidance you're sure that the online service should handle your application, "
            + "contact <a href=\"mailto:probatefeedback@justice.co.uk\" class=\"govuk-link\" target=\"_blank\">"
            + "probatefeedback@justice.co.uk</a> with the broad details of your application and we will help to progress "
            + "your application.</p>\n\n\n\n</div>";
