...
public class AssembleTestBase {
    ...
    protected void assertAllForStaticField(List<ParagraphDetail> response, ParagraphCode code, HashMap<ParagraphCode,
        ...
        assertAllForStaticField(response, code2expected.get(code)[0], code2expected.get(code)[1],
            code2expected.get(code)[2]);

    }

    protected void assertAllForStaticField(List<ParagraphDetail> response, String detailCode, String templateName,
                                           String label) {
    ...
    protected void assertAllForTextField(List<ParagraphDetail> response, ParagraphCode code, HashMap<ParagraphCode,
        String[]> code2expected) {
        assertAllForTextField(response, code2expected.get(code)[0], code2expected.get(code)[1],
            code2expected.get(code)[2]);

    }

    protected void assertAllForTextField(List<ParagraphDetail> response, String detailCode, String templateName,
                                         String label) {
        assertEquals(detailCode, response.get(0).getCode());
        assertEquals(templateName, response.get(0).getTemplateName());
        assertEquals(null, response.get(0).getTextValue());
    ...
    protected void assertAllForTextFieldWithDefault(List<ParagraphDetail> response, ParagraphCode code,
                                                    HashMap<ParagraphCode,
                                                        String[]> code2expected) {
        assertAllForTextFieldWithDefault(response, code2expected.get(code)[0], code2expected.get(code)[1],
            code2expected.get(code)[2],
            code2expected.get(code)[3]);

    }

    protected void assertAllForTextFieldWithDefault(List<ParagraphDetail> response, String detailCode,
                                                    String templateName, String label,
                                                    String defaultValue) {
        assertEquals(detailCode, response.get(0).getCode());
        assertEquals(templateName, response.get(0).getTemplateName());
