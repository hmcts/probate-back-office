...
class CaveatControllerIT {
    ...
    @Test
    void caveatSupplementaryData_shouldReturnBadRequestWhenCaseDetailsMissing() throws Exception {
    ...
    @Test
    void caveatSupplementaryData_shouldReturnBadRequestWhenCaseIdMissing() throws Exception {
