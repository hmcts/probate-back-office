...
How to pay
=================
[Pay the application fee](cases/case-details/PROBATE/{{caseType}}/{{caseReference}}#Service%20Request) using Payment by Account (PBA) or a credit or debit card by returning to the case details and selecting the Service Request tab.
...
=================
**Cyfeirnod y cais:** {{solicitorReference}}

**Cyflwynwyd ar:** {{caseSubmissionDate}}

Sut i dalu
=================
[Talu ffi’r cais](cases/case-details/PROBATE/{{caseType}}/{{caseReference}}#Service%20Request) defnyddio Trosglwyddiad Cyfrif (PBA) neu gerdyn credyd neu ddebyd trwy ddychwelyd at fanylion yr achos a dewis y tab Cais am Daliad.
