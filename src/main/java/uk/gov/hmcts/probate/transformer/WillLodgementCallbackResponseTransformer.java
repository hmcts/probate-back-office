...
public class WillLodgementCallbackResponseTransformer {
    ...
    private ResponseWillLodgementData.ResponseWillLodgementDataBuilder getResponseWillLodgementData(WillLodgementDetails willLodgementDetails) {
        ...
        return ResponseWillLodgementData.builder()
                ...
                .deceasedDateOfBirth(dateTimeFormatter.format(willLodgementData.getDeceasedDateOfBirth()))
                .deceasedTypeOfDeath(transformToString(willLodgementData.getDeceasedDateOfDeath()))
