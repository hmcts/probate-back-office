...
public class SolicitorLegalStatementNextStepsTransformer {
    ...
    public static final String GRANT_TYPE_ADMON_LABEL = "Letters of administration with will annexed where the deceased left a will but none of the executors can apply";
    ...
    public void transformLegalStatmentAmendStates(@Valid CaseDetails caseDetails,
        ...
        responseCaseDataBuilder.solsAmendLegalStatmentSelect(getAppropriateNextEventsForSolicitorLegalStatementAmend(caseDetails.getData()));
    }
