...
public class DuplicateSecurityConfiguration extends WebSecurityConfigurerAdapter {

    private final AuthCheckerServiceOnlyFilter filter;
    private final AuthenticationExceptionHandler authenticationExceptionHandler;

    public DuplicateSecurityConfiguration(RequestAuthorizer<Service> serviceRequestAuthorizer,
