...
public interface NotApplyingExecutorsBusinessRule extends BusinessRule {

    default boolean isPrimaryNotApplying(CaseData caseData, String notApplyingReason) {
    ...
    default boolean isSolExecNotApplying(CaseData caseData, String notApplyingReason) {
    ...
    default boolean anyAdditionalExecsNotApplying(CaseData caseData, String notApplyingReason) {
    ...
    default boolean anySolsAdditionalExecs(CaseData caseData, String notApplyingReason) {
