...
public class GenericMapperService {
    ...
    public Map<String, Object> addCaseDataWithRegistryProperties(CaseDetails caseDetails) {
        ...
        Registry registry = registriesProperties.getRegistries().get("english").getEnglish().get(caseData.getRegistryLocation());
        ...
        if (caseDetails.getData().isLanguagePreferenceWelsh()) {
            Registry registryWelsh = registriesProperties.getRegistries().get("welsh").getWelsh().get(caseData.getRegistryLocation());
