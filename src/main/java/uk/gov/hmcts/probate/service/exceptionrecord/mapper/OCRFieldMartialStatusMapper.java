...
public class OCRFieldMartialStatusMapper {
    ...
    @ToMartialStatus
    public MaritalStatus toMartialStatus(String martialStatusValue) {
        ...
        if (martialStatusValue == null || martialStatusValue.isEmpty()) {
            ...
            switch (martialStatusValue.trim()) {
                ...
                default:
                    String errorMessage = "deceasedMartialStatus: 'neverMarried', 'widowed', "
                            + "'marriedCivilPartnership', 'divorcedCivilPartnership' or 'judicially' "
                            + "expected but got '" + martialStatusValue + "'";
