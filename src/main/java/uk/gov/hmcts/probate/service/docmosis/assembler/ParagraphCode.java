...
public enum ParagraphCode {
    ...
    solsAffidDate("FL-PRB-GNO-ENG-00198.docx", SOLS_AFFID_DATE),
    solsAffidSearch("FL-PRB-GNO-ENG-00199.docx", SOLS_AFFID_SEARCH),
    solsAffidRecital("FL-PRB-GNO-ENG-00200.docx", SOLS_AFFID_RECITAL);
