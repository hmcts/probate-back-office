...
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_AFFID_ALIAS;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_AFFID_ALIAS_INT;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_AFFID_ALTERATIONS;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_AFFID_DATE;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_AFFID_EXEC;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_AFFID_HANDWRITING;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_AFFID_IDENTITY;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_AFFID_KNOWLEDGE;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_AFFID_RECITAL;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_AFFID_SEARCH;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_CERT_ALIAS;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_CERT_DECEASED_ADD;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_CERT_DEPONENT_ADD;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_CERT_DIVORCE;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_CERT_DIVORCE_DISOOLVE;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_CERT_DOB;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_CERT_DOD;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_CERT_EPA_LPA;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_CERT_EXEC_NAME;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_CERT_EXEC_NOT_ACCOUNTED;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_CERT_FIRM_SUCC;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_CERT_LIFE_MINORITY;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_CERT_OTHER_WILL;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_CERT_PARTENRS_DOD;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_CERT_PLIGHT;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_CERT_POWER_RESERVED;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_CERT_SETTLED_LAND;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_CERT_SPOUSE;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_CERT_SURVIVAL_EXEC;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_CERT_TRUST_CORP;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_CERT_WILL_SEP_PAGES;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_GEN_AUTH;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_GEN_EXTENDED_RENUN;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_GEN_POWER_ATTORNEY;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_GEN_VOID;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_REDEC_CLEARING;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_REDEC_CODICIL;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_REDEC_DOMICILE;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_REDEC_INT_FOR_DOM;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_REDEC_MINORITY;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_REDEC_NET_ESTATE;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_REDEC_SOT_DATE;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_REDEC_SOT_SIGNED;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_REDEC_TITLE;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_REDEC_WILLS_FOR_DOM;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOT_NOT_SIGNED;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOT_PA1A_Q2;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOT_PA1A_Q3;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOT_PA1A_Q4;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOT_PA1A_Q5;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOT_PA1A_Q6;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOT_PA1A_REDEC;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOT_PA1P_Q2;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOT_PA1P_Q3;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOT_PA1P_Q4;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOT_PA1P_Q5;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOT_PA1P_Q6;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOT_PA1P_Q7;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOT_PA1P_REDEC;
...
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.WIT_CONSENT;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.WIT_DATE;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.WIT_EXECUTION;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.WIT_SIGNATURE;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.ENT_TWO_APPLICATIONS_REGISTRY;
...
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_GEN_EXTENDED_RENUN_FOUR;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_GEN_EXTENDED_RENUN_THREE;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_GEN_EXTENDED_RENUN_TWO;
import static uk.gov.hmcts.probate.service.docmosis.assembler.ParagraphField.SOLS_CERT_EXEC_NAME_WILL;
...
public enum ParagraphCode {
    ...
    EntTwoApps("FL-PRB-GNO-ENG-00138.docx", ENT_TWO_APPLICATIONS, ENT_TWO_APPLICATIONS_REGISTRY),
    ...
    MissInfoDeceased("FL-PRB-GNO-ENG-00153.docx", MISS_INFO_DECEASED_COUNTRY, MISS_INFO_DECEASED_DATE),
    ...
    solsGenAuthorityPartners("FL-PRB-GNO-ENG-00112.docx", SOLS_GEN_AUTH),
    solsGenExtendedRenun("FL-PRB-GNO-ENG-00175.docx", SOLS_GEN_EXTENDED_RENUN,
            SOLS_GEN_EXTENDED_RENUN_TWO, SOLS_GEN_EXTENDED_RENUN_THREE, SOLS_GEN_EXTENDED_RENUN_FOUR),
    solsGenPowerAttorney("FL-PRB-GNO-ENG-00113.docx", SOLS_GEN_POWER_ATTORNEY),
    solsGenVoid("FL-PRB-GNO-ENG-00114.docx", SOLS_GEN_VOID),
    ...
    solsCertExecName("FL-PRB-GNO-ENG-00187.docx", SOLS_CERT_EXEC_NAME, SOLS_CERT_EXEC_NAME_WILL),
    ...
    solsRedecSotDate("FL-PRB-GNO-ENG-00200.docx", SOLS_REDEC_SOT_DATE, SOLS_REDEC_SOT_WILL),
    solsRedecCodicil("FL-PRB-GNO-ENG-00201.docx", SOLS_REDEC_CODICIL),
