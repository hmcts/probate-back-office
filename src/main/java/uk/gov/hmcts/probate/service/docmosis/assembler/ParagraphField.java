...
public enum ParagraphField {
    ...
    MISS_INFO_FEE("MissInfoFee", "Missing fee amount", "missingFeeAmount"),
    ...
    SOLS_GEN_EXTENDED_RENUN("GenExtendRenunciation", "Sol: Extended renunciation", "clauseNumberExtendedRenun"),
    SOLS_GEN_EXTENDED_RENUN_TWO("GenExtendRenunciation1", "Sol: Extended renunciation", "personNamedInClause"),
    SOLS_GEN_EXTENDED_RENUN_THREE("GenExtendRenunciation2", "Sol: Extended renunciation", "reciteExecutorClause"),
    SOLS_GEN_EXTENDED_RENUN_FOUR("GenExtendRenunciation3", "Sol: Extended renunciation", "personsNamedInWill"),
    ...
    SOLS_CERT_EXEC_NAME("CertsExecName", "Executor name - sols", "nameOfExecutorSolsCert"),
    SOLS_CERT_EXEC_NAME_WILL("CertsExecNameWill", "Executor name - will", "nameOfExecutorInWill"),
