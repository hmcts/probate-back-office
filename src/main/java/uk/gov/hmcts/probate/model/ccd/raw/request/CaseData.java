...
public class CaseData {
    ...
    private List<CollectionMember<AdditionalExecutorApplying>> executorsApplying;

    private List<CollectionMember<AdditionalExecutorNotApplying>> executorsNotApplying;
