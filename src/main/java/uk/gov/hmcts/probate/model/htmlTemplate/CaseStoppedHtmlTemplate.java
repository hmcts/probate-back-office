...
public class CaseStoppedHtmlTemplate {
    ...
    public static List<String> caseStopReasons = Arrays.asList(new String[]{"an internal review is needed", "further information from the applicant or solicitor is needed"});
}
