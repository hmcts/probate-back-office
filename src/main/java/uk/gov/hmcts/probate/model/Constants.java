...
public final class Constants {
    ...
    public static final String WILL_TYPE_PROBATE = "WillLeft";
    public static final String WILL_TYPE_INTESTACY = "NoWill";
    public static final String WILL_TYPE_ADMON = "WillLeftAnnexed";
