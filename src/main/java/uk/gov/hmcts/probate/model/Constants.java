...
public final class Constants {
    ...
    public static final String STATEMENT_OF_TRUTH_AND_EXHIBITS_TEXT = "statement of truth and Exhibits that lead to a R54 Order NCPR 1987 to prove the will is lost, and that it has not been revoked";
