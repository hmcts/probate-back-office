...
public final class Constants {
    ...
    public static final String NOTARIAL_COPY_WILL_TEXT_WELSH = "the notarial or court sealed copy of the will";
    ...
    public static final String ORIGINAL_WILL_WITH_CODICILS_TEXT_WELSH = "the original will and any codicils";
