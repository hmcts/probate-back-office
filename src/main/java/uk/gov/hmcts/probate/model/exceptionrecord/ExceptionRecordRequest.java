...
public class ExceptionRecordRequest {
    ...
    public ExceptionRecordOCRFields getOCRFieldsObject() {
        ...
        return ExceptionRecordOCRFields.builder()
                ...
                .executorsNotApplying0notApplyingExecutorName(get(ocrFields, "executorsNotApplying0notApplyingExecutorName"))
                .executorsNotApplying0notApplyingExecutorReason(get(ocrFields, "executorsNotApplying0notApplyingExecutorReason"))
                .executorsNotApplying1notApplyingExecutorName(get(ocrFields, "executorsNotApplying1notApplyingExecutorName"))
                .executorsNotApplying1notApplyingExecutorReason(get(ocrFields, "executorsNotApplying1notApplyingExecutorReason"))
                .executorsNotApplying2notApplyingExecutorName(get(ocrFields, "executorsNotApplying2notApplyingExecutorName"))
                .executorsNotApplying2notApplyingExecutorReason(get(ocrFields, "executorsNotApplying2notApplyingExecutorReason"))
