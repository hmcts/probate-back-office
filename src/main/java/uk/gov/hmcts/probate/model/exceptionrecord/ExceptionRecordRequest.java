...
public class ExceptionRecordRequest {
    ...
    public ExceptionRecordOCRFields getOCRFieldsObject() {
        ...
        return ExceptionRecordOCRFields.builder()
            .caveatorForenames(get(ocrFields, "caveatorForenames", "caveatorMiddleNames", modifiedFields))
            .caveatorSurnames(get(ocrFields, "caveatorSurnames"), modifiedFields)
            .caveatorEmailAddress(get(ocrFields, "caveatorEmailAddress"))
            .caveatorAddressLine1(get(ocrFields, "caveatorAddressLine1"), modifiedFields)
            ...
            .caveatorAddressPostCode(get(ocrFields, "caveatorAddressPostCode"), modifiedFields)
            .deceasedForenames(get(ocrFields, "deceasedForenames", "deceasedMiddleNames", modifiedFields))
            .deceasedSurname(get(ocrFields, "deceasedSurname"), modifiedFields)
            .deceasedAnyOtherNames(get(ocrFields, "deceasedAnyOtherNames"), modifiedFields)
            .deceasedAddressLine1(get(ocrFields, "deceasedAddressLine1"), modifiedFields)
            ...
            .deceasedDateOfBirth(get(ocrFields, "deceasedDateOfBirth", modifiedFields))
            .deceasedDateOfDeath(get(ocrFields, "deceasedDateOfDeath"))
            .solsSolicitorRepresentativeName(get(ocrFields, "solsSolicitorRepresentativeName", modifiedFields))
            .solsSolicitorFirmName(get(ocrFields, "solsSolicitorFirmName", modifiedFields))
            .solsSolicitorAppReference(get(ocrFields, "solsSolicitorAppReference", modifiedFields))
            .solsFeeAccountNumber(get(ocrFields, "solsFeeAccountNumber"))
            .solsSolicitorAddressLine1(get(ocrFields, "solsSolicitorAddressLine1", modifiedFields))
            .solsSolicitorAddressLine2(get(ocrFields, "solsSolicitorAddressLine2", modifiedFields))
            .solsSolicitorAddressTown(get(ocrFields, "solsSolicitorAddressTown", modifiedFields))
            .solsSolicitorAddressCounty(get(ocrFields, "solsSolicitorAddressCounty", modifiedFields))
            .solsSolicitorAddressPostCode(get(ocrFields, "solsSolicitorAddressPostCode", modifiedFields))
            .solsSolicitorEmail(get(ocrFields, "solsSolicitorEmail", modifiedFields))
            .solsSolicitorPhoneNumber(get(ocrFields, "solsSolicitorPhoneNumber", modifiedFields))
            ...
            .solsFeeAccountNumber(get(ocrFields, "solsFeeAccountNumber"))
            .primaryApplicantForenames(getDefaultPrimaryApplicantForenamesIfInvalid(ocrFields, "primaryApplicantForenames", "primaryApplicantMiddleNames", modifiedFields))
            .primaryApplicantSurname(get(ocrFields, "primaryApplicantSurname", modifiedFields))
            .primaryApplicantAddressLine1(getDefaultPrimaryApplicantAddressLine1(ocrFields, "primaryApplicantAddressLine1", modifiedFields))
            ...
            .primaryApplicantAddressPostCode(get(ocrFields, "primaryApplicantAddressPostCode"), modifiedFields)
            ...
            .executorsApplying0applyingExecutorAddressLine1(
                get(ocrFields, "executorsApplying_0_applyingExecutorAddressLine1"))
            .executorsApplying0applyingExecutorAddressLine2(
                get(ocrFields, "executorsApplying_0_applyingExecutorAddressLine2"))
            .executorsApplying0applyingExecutorAddressTown(
                get(ocrFields, "executorsApplying_0_applyingExecutorAddressTown"))
            .executorsApplying0applyingExecutorAddressCounty(
                get(ocrFields, "executorsApplying_0_applyingExecutorAddressCounty"))
            .executorsApplying0applyingExecutorAddressPostCode(
                get(ocrFields, "executorsApplying_0_applyingExecutorAddressPostCode"))
            ...
            .executorsApplying0applyingExecutorOtherNames(
                get(ocrFields, "executorsApplying_0_applyingExecutorOtherNames"))
            ...
            .executorsApplying1applyingExecutorAddressLine1(
                get(ocrFields, "executorsApplying_1_applyingExecutorAddressLine1"))
            .executorsApplying1applyingExecutorAddressLine2(
                get(ocrFields, "executorsApplying_1_applyingExecutorAddressLine2"))
            .executorsApplying1applyingExecutorAddressTown(
                get(ocrFields, "executorsApplying_1_applyingExecutorAddressTown"))
            .executorsApplying1applyingExecutorAddressCounty(
                get(ocrFields, "executorsApplying_1_applyingExecutorAddressCounty"))
            .executorsApplying1applyingExecutorAddressPostCode(
                get(ocrFields, "executorsApplying_1_applyingExecutorAddressPostCode"))
            ...
            .executorsApplying1applyingExecutorOtherNames(
                get(ocrFields, "executorsApplying_1_applyingExecutorOtherNames"))
            ...
            .executorsApplying2applyingExecutorAddressLine1(
                get(ocrFields, "executorsApplying_2_applyingExecutorAddressLine1"))
            .executorsApplying2applyingExecutorAddressLine2(
                get(ocrFields, "executorsApplying_2_applyingExecutorAddressLine2"))
            .executorsApplying2applyingExecutorAddressTown(
                get(ocrFields, "executorsApplying_2_applyingExecutorAddressTown"))
            .executorsApplying2applyingExecutorAddressCounty(
                get(ocrFields, "executorsApplying_2_applyingExecutorAddressCounty"))
            .executorsApplying2applyingExecutorAddressPostCode(
                get(ocrFields, "executorsApplying_2_applyingExecutorAddressPostCode"))
            ...
            .solsSolicitorAppReference(get(ocrFields, "solsSolicitorAppReference"), modifiedFields) //Y
            .solsSolicitorAddressLine1(get(ocrFields, "solsSolicitorAddressLine1"), modifiedFields) //Y
            .solsSolicitorAddressLine2(get(ocrFields, "solsSolicitorAddressLine2"), modifiedFields) //Y
            .solsSolicitorAddressTown(get(ocrFields, "solsSolicitorAddressTown"), modifiedFields) //Y
            .solsSolicitorAddressCounty(get(ocrFields, "solsSolicitorAddressCounty"))
            .solsSolicitorAddressPostCode(get(ocrFields, "solsSolicitorAddressPostCode"), modifiedFields) //Y
            .solsSolicitorEmail(get(ocrFields, "solsSolicitorEmail"), modifiedFields) //Y
            .solsSolicitorPhoneNumber(get(ocrFields, "solsSolicitorPhoneNumber"), modifiedFields) //Y
            .deceasedDomicileInEngWales(get(ocrFields, "deceasedDomicileInEngWales"), modifiedFields) //Y
            ...
            .wholeBloodUnclesAndAuntsSurvivedUnderEighteen(
                get(ocrFields, "wholeBloodUnclesAndAuntsSurvivedUnderEighteen"))
            .wholeBloodUnclesAndAuntsSurvivedOverEighteen(
                get(ocrFields, "wholeBloodUnclesAndAuntsSurvivedOverEighteen"))
            ...
            .halfBloodUnclesAndAuntsSurvivedUnderEighteen(
                get(ocrFields, "halfBloodUnclesAndAuntsSurvivedUnderEighteen"))
            ...
            .executorsNotApplying0notApplyingExecutorName(
                get(ocrFields, "executorsNotApplying_0_notApplyingExecutorName"))
            .executorsNotApplying0notApplyingExecutorReason(
                get(ocrFields, "executorsNotApplying_0_notApplyingExecutorReason"))
            .executorsNotApplying1notApplyingExecutorName(
                get(ocrFields, "executorsNotApplying_1_notApplyingExecutorName"))
            .executorsNotApplying1notApplyingExecutorReason(
                get(ocrFields, "executorsNotApplying_1_notApplyingExecutorReason"))
            .executorsNotApplying2notApplyingExecutorName(
                get(ocrFields, "executorsNotApplying_2_notApplyingExecutorName"))
            .executorsNotApplying2notApplyingExecutorReason(
                get(ocrFields, "executorsNotApplying_2_notApplyingExecutorReason"))
            ...
            .iht400Completed(get(ocrFields, "iht400completed"))
            .iht400421Completed(get(ocrFields, "iht400421completed"))
            .iht207Completed(get(ocrFields, "iht207completed"))
            .iht205Completed(get(ocrFields, "iht205completed"))
            .iht205completedOnline(get(ocrFields, "iht205completedOnline"))
            .exceptedEstate(get(ocrFields, "exceptedEstate"))
            .iht400process(get(ocrFields, "iht400process"))
            .ihtCode(get(ocrFields, "ihtCode"))
            .ihtGrossValueExceptedEstate(get(ocrFields, "ihtGrossValueExceptedEstate"))
            .ihtNetValueExceptedEstate(get(ocrFields, "ihtNetValueExceptedEstate"))
            .probateGrossValueIht400(get(ocrFields, "probateGrossValueIht400"))
            .probateNetValueIht400(get(ocrFields, "probateNetValueIht400"))
            .iht421grossValue(get(ocrFields, "iht421grossValue"))
            .iht421netValue(get(ocrFields, "iht421netValue"))
            .iht207grossValue(get(ocrFields, "iht207grossValue"))
            .iht207netValue(get(ocrFields, "iht207netValue"))
            .ihtGrossValue205(get(ocrFields, "ihtGrossValue205"))
            .ihtNetValue205(get(ocrFields, "ihtNetValue205"))
            ...
            .legalRepresentative(get(ocrFields, "legalRepresentative", modifiedFields)) //
