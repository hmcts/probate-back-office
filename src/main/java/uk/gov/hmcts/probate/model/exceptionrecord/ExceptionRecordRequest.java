...
public class ExceptionRecordRequest {
    ...
    public ExceptionRecordOCRFields getOCRFieldsObject() {
        ...
        return ExceptionRecordOCRFields.builder()
            ...
            .deceasedAnyOtherNames(getDefaultNameIfInvalid(ocrFields, "deceasedAnyOtherNames", modifiedFields))
            ...
            .solsSolicitorRepresentativeName(getDefaultNameIfInvalid(ocrFields, "solsSolicitorRepresentativeName", modifiedFields))
            ...
            .solsSolicitorRepresentativeName(getDefaultRepresentativeNameIfInvalid(ocrFields, "solsSolicitorRepresentativeName", modifiedFields))
            .solsSolicitorFirmName(get(ocrFields, "solsSolicitorFirmName"))
            .solsSolicitorAppReference(getDefaultSolsAppReferenceIfInvalid(ocrFields, "solsSolicitorAppReference", modifiedFields))
            .solsSolicitorAddressLine1(getDefaultAddressLineIfInvalid(ocrFields, "solsSolicitorAddressLine1", modifiedFields))
            .solsSolicitorAddressLine2(getDefaultAddressLineIfInvalid(ocrFields, "solsSolicitorAddressLine2", modifiedFields))
            .solsSolicitorAddressTown(getDefaultSolsSolicitorAddressTownIfInvalid(ocrFields, "solsSolicitorAddressTown", modifiedFields))
            ...
            .legalRepresentative(getDefaultLegalRepresentativeIfInvalid(ocrFields, "legalRepresentative", modifiedFields))
