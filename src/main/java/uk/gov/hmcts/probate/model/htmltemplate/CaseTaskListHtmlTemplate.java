...
public class CaseTaskListHtmlTemplate {
    ...
    public static final String TASK_LIST_TEMPLATE =
        ...
        + "<status-sendDocuments/></gridCol-one-third></gridRow>\n"
        + SEPARATOR
        + "<br/>\n"
        ...
        + "<status-authDocuments/></gridCol-one-third></gridRow>\n"
        + "<authenticatedDate/>"
        + "<gridRow><gridCol-two-thirds><p><secText>We will authenticate your documents and match them with your application.</secText>"
        + "</p></gridCol-two-thirds><gridCol-one-third>&nbsp;</gridCol-one-third></gridRow>\n"
        + SEPARATOR
        ...
        + "<gridCol-one-third>&nbsp;</gridCol-one-third></gridRow>\n"
        + "<gridRow><gridCol-two-thirds><p><secText>Your application will update through any of these case states as it is "
        + "reviewed by our team:</secText></p></gridCol-two-thirds><gridCol-one-third>&nbsp;</gridCol-one-third></gridRow>\n"
