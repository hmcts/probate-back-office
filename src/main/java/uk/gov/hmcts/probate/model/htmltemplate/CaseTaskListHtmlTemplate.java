...
public class CaseTaskListHtmlTemplate {
    ...
    public static final String TASK_LIST_TEMPLATE =
        ...
        + "<status-addDeceasedDetailsWelsh/>"
        + CLOSE_GRID_ROW
        + SEPARATOR
        + OPEN_ROW
        + "<p><addAppLink/></p>"
        ...
        + "<h>Llofnodi'r datganiad cyfreithiol a chyflwyno'r cais</h>\n"
        + OPEN_ROW
        ...
        + CLOSE_GRID_ROW
        + OPEN_ROW
        + "<p><secText>Bydd y grant yn cael ei anfon yn y post o fewn 10 diwrnod gwaith ar ôl iddo gael ei gyflwyno."
        + "</secText></p>"
        + CLOSE_GRID_ROW_WITH_EMPTY_COLUMN
        + SEPARATOR
        + "</gridCol-two-thirds>\n"
