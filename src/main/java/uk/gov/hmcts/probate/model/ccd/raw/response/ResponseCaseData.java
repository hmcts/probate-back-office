...
public class ResponseCaseData extends ResponseCaseDataParent{
    ...
    public static class ResponseCaseDataBuilder  extends ResponseCaseDataParentBuilder{
        ...
        @Override
        public ResponseCaseDataBuilder taskList(String taskList) {
            this.taskList = taskList;
            return this;
        }

        @Override
        public ResponseCaseDataBuilder escalatedDate(String escalatedDate) {
            this.escalatedDate = escalatedDate;
            return this;
        }

        @Override
        public ResponseCaseDataBuilder authenticatedDate(String authenticatedDate) {
        ...
        public ResponseCaseData build() {
            ...
            responseCaseData.taskList = responseCaseDataParent.taskList;
            responseCaseData.escalatedDate = responseCaseDataParent.escalatedDate;
            responseCaseData.authenticatedDate = responseCaseDataParent.authenticatedDate;
