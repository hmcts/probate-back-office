...
public class ResponseCaseData extends ResponseCaseDataParent{
    ...
    ResponseCaseData(String state, ApplicationType applicationType, String registryLocation, String deceasedDateOfDeath, String deceasedDateOfBirth, String deceasedForenames, String deceasedSurname, String solsSolicitorFirmName, SolsAddress solsSolicitorAddress, String solsSolicitorEmail, String solsSolicitorPhoneNumber, String solsSOTName, String solsSOTForenames, String solsSOTSurname, String solsSOTJobTitle, String solsSolicitorAppReference, String ihtFormId, String solsSolicitorIsExec, String solsSolicitorIsMainApplicant, String solsSolicitorIsApplying, String solsSolicitorNotApplyingReason, String solsWillType, String solsApplicantRelationshipToDeceased, String solsSpouseOrCivilRenouncing, String solsAdoptedEnglandOrWales, String solsMinorityInterest, String solsApplicantSiblings, String solsEntitledMinority, String solsDiedOrNotApplying, String solsResiduary, String solsResiduaryType, String solsLifeInterest, String willExists, String willAccessOriginal, String willHasCodicils, String willNumberOfCodicils, BigDecimal ihtNetValue, BigDecimal ihtGrossValue, String deceasedDomicileInEngWales, String extraCopiesOfGrant, String outsideUKGrantCopies, String applicationFee, String feeForUkCopies, String feeForNonUkCopies, String totalFee, String solsPaymentMethods, String solsFeeAccountNumber, String paymentReferenceNumber, DocumentLink solsLegalStatementDocument, DocumentLink statementOfTruthDocument, List<CollectionMember<Document>> probateDocumentsGenerated, List<CollectionMember<Document>> probateNotificationsGenerated, List<CollectionMember<UploadDocument>> boDocumentsUploaded, List<CollectionMember<CaseMatch>> caseMatches, String solsSOTNeedToUpdate, DocumentLink solsNextStepsDocument, String solsAdditionalInfo, String primaryApplicantForenames, String primaryApplicantSurname, String primaryApplicantEmailAddress, String primaryApplicantHasAlias, String primaryApplicantIsApplying, String solsPrimaryExecutorNotApplyingReason, String otherExecutorExists, String primaryApplicantAlias, String primaryApplicantSameWillName, String primaryApplicantAliasReason, String primaryApplicantOtherReason, String solsExecutorAliasNames, List<CollectionMember<AdditionalExecutorApplying>> additionalExecutorsApplying, List<CollectionMember<AdditionalExecutorNotApplying>> additionalExecutorsNotApplying, List<CollectionMember<AdditionalExecutor>> solsAdditionalExecutorList, SolsAddress deceasedAddress, String deceasedAnyOtherNames, SolsAddress primaryApplicantAddress, List<CollectionMember<AliasName>> solsDeceasedAliasNamesList, List<CollectionMember<ProbateAliasName>> deceasedAliasNamesList, String casePrinted, String boEmailDocsReceivedNotificationRequested, String boEmailGrantIssuedNotificationRequested, String boEmailDocsReceivedNotification, String boEmailGrantIssuedNotification, List<CollectionMember<StopReason>> boCaseStopReasonList, String boStopDetails, String boDeceasedTitle, String boDeceasedHonours, String boWillMessage, String boExecutorLimitation, String boAdminClauseLimitation, String boLimitationText, String ihtReferenceNumber, String ihtFormCompletedOnline, LegalStatement legalStatement, Declaration declaration, String deceasedMarriedAfterWillOrCodicilDate, String primaryApplicantPhoneNumber, String boExaminationChecklistQ2, String boExaminationChecklistQ1, String boExaminationChecklistRequestQA, List<CollectionMember<Payment>> payments, String applicationSubmittedDate, List<CollectionMember<ScannedDocument>> scannedDocuments, String evidenceHandled, String caseType, String paperForm, String languagePreferenceWelsh, String primaryApplicantSecondPhoneNumber, String primaryApplicantRelationshipToDeceased, String paRelationshipToDeceasedOther, String applicationFeePaperForm, String feeForCopiesPaperForm, String totalFeePaperForm, String paperPaymentMethod, String paymentReferenceNumberPaperform, String entitledToApply, String entitledToApplyOther, String notifiedApplicants, String foreignAsset, String foreignAssetEstateValue, String adopted, List<CollectionMember<AdoptedRelative>> adoptiveRelatives, String mentalCapacity, String courtOfProtection, String epaOrLpa, String epaRegistered, String domicilityCountry, List<CollectionMember<EstateItem>> ukEstate, String domicilityIHTCert, String solsEntrustingDoc, String applicationGrounds, String willDispose, String englishWill, String appointExec, String appointExecByDuties, String solsDomicilityCert, String willDatedBeforeApril, String deceasedEnterMarriageOrCP, String deceasedMaritalStatus, String willsOutsideOfUK, String courtOfDecree, String dateOfMarriageOrCP, String dateOfDivorcedCPJudicially, String willGiftUnderEighteen, String applyingAsAnAttorney, List<CollectionMember<AttorneyApplyingOnBehalfOf>> attorneyOnBehalfOfNameAndAddress, String spouseOrPartner, String childrenSurvived, String childrenOverEighteenSurvived, String childrenUnderEighteenSurvived, String childrenDied, String childrenDiedOverEighteen, String childrenDiedUnderEighteen, String parentsExistSurvived, String parentsExistOverEighteenSurvived, String parentsExistUnderEighteenSurvived, String wholeBloodNeicesAndNephews, String wholeBloodNeicesAndNephewsOverEighteen, String wholeBloodNeicesAndNephewsUnderEighteen, String wholeBloodSiblingsDied, String wholeBloodSiblingsDiedOverEighteen, String wholeBloodSiblingsDiedUnderEighteen, String wholeBloodSiblingsSurvived, String wholeBloodSiblingsSurvivedOverEighteen, String wholeBloodSiblingsSurvivedUnderEighteen, String halfBloodSiblingsDied, String halfBloodSiblingsDiedOverEighteen, String halfBloodSiblingsDiedUnderEighteen, String halfBloodSiblingsSurvived, String halfBloodSiblingsSurvivedOverEighteen, String halfBloodSiblingsSurvivedUnderEighteen, String grandparentsDied, String grandparentsDiedOverEighteen, String grandparentsDiedUnderEighteen, String halfBloodNeicesAndNephews, String halfBloodNeicesAndNephewsOverEighteen, String halfBloodNeicesAndNephewsUnderEighteen, String grandChildrenSurvived, String grandChildrenSurvivedOverEighteen, String grandChildrenSurvivedUnderEighteen, String wholeBloodUnclesAndAuntsDied, String wholeBloodUnclesAndAuntsDiedOverEighteen, String wholeBloodUnclesAndAuntsDiedUnderEighteen, String wholeBloodUnclesAndAuntsSurvived, String wholeBloodUnclesAndAuntsSurvivedOverEighteen, String wholeBloodUnclesAndAuntsSurvivedUnderEighteen, String halfBloodUnclesAndAuntsSurvived, String halfBloodUnclesAndAuntsSurvivedOverEighteen, String halfBloodUnclesAndAuntsSurvivedUnderEighteen, String halfBloodUnclesAndAuntsDied, String halfBloodUnclesAndAuntsDiedOverEighteen, String halfBloodUnclesAndAuntsDiedUnderEighteen, String halfBloodCousinsSurvived, String halfBloodCousinsSurvivedOverEighteen, String halfBloodCousinsSurvivedUnderEighteen, String wholeBloodCousinsSurvived, String wholeBloodCousinsSurvivedOverEighteen, String wholeBloodCousinsSurvivedUnderEighteen, String boSendToBulkPrint, String boSendToBulkPrintRequested, String grantIssuedDate, String dateOfDeathType, List<CollectionMember<CaseMatch>> legacySearchResultRows, String recordId, String legacyType, String legacyCaseViewUrl, String bulkPrintSendLetterId, String bulkPrintPdfSize, List<CollectionMember<BulkPrint>> bulkPrintId, String boCaveatStopNotificationRequested, String boCaveatStopNotification, String boCaseStopCaveatId, String boCaveatStopEmailNotificationRequested, String boCaveatStopEmailNotification, String boCaveatStopSendToBulkPrintRequested, String boCaveatStopSendToBulkPrint, String boEmailGrantReissuedNotificationRequested, String boEmailGrantReissuedNotification, String boGrantReissueSendToBulkPrint, String boGrantReissueSendToBulkPrintRequested, String orderNeeded, List<CollectionMember<Reissue>> reissueReason, String reissueDate, String reissueReasonNotation, String latestGrantReissueDate, String deceasedDivorcedInEnglandOrWales, String primaryApplicantAdoptionInEnglandOrWales, String deceasedSpouseNotApplyingReason, String deceasedOtherChildren, String allDeceasedChildrenOverEighteen, String anyDeceasedChildrenDieBeforeDeceased, String anyDeceasedGrandChildrenUnderEighteen, String deceasedAnyChildren, String deceasedHasAssetsOutsideUK, String solicitorIsMainApplicant, String boStopDetailsDeclarationParagraph, String boEmailRequestInfoNotificationRequested, String boEmailRequestInfoNotification, String boRequestInfoSendToBulkPrint, String boRequestInfoSendToBulkPrintRequested, String boAssembleLetterSendToBulkPrint, String boAssembleLetterSendToBulkPrintRequested, List<CollectionMember<ExecutorsApplyingNotification>> executorsApplyingNotifications, List<CollectionMember<Document>> probateSotDocumentsGenerated, Categories categories, DocumentLink previewLink, List<CollectionMember<ParagraphDetail>> paragraphDetails, String bulkScanCaseReference, String grantDelayedNotificationDate, String grantStoppedDate, String grantDelayedNotificationIdentified, String grantDelayedNotificationSent, String grantAwaitingDocumentationNotificationDate, String grantAwaitingDocumentatioNotificationSent) {
        ...
        this.solsEntrustingDoc = solsEntrustingDoc;
        ...
        this.solsDomicilityCert = solsDomicilityCert;
    ...
    public static class ResponseCaseDataBuilder  extends ResponseCaseDataParentBuilder{
        ...
        public ResponseCaseDataBuilder solsEntrustingDoc(String solsEntrustingDoc) {
            this.solsEntrustingDoc = solsEntrustingDoc;
            return this;
        }
        ...
        public ResponseCaseDataBuilder solsDomicilityCert(String solsDomicilityCert) {
            this.solsDomicilityCert = solsDomicilityCert;
            return this;
        }
        ...
        public ResponseCaseData build() {
            ResponseCaseData responseCaseData = new ResponseCaseData(state, applicationType, registryLocation, deceasedDateOfDeath, deceasedDateOfBirth, deceasedForenames, deceasedSurname, solsSolicitorFirmName, solsSolicitorAddress, solsSolicitorEmail, solsSolicitorPhoneNumber, solsSOTName,
                ...
                solsAdoptedEnglandOrWales, solsMinorityInterest, solsApplicantSiblings, solsEntitledMinority, solsDiedOrNotApplying, solsResiduary, solsResiduaryType, solsLifeInterest, willExists, willAccessOriginal, willHasCodicils, willNumberOfCodicils, ihtNetValue, ihtGrossValue, deceasedDomicileInEngWales, extraCopiesOfGrant, outsideUKGrantCopies, applicationFee, feeForUkCopies, feeForNonUkCopies, totalFee, solsPaymentMethods, solsFeeAccountNumber, paymentReferenceNumber, solsLegalStatementDocument, statementOfTruthDocument, probateDocumentsGenerated, probateNotificationsGenerated, boDocumentsUploaded, caseMatches, solsSOTNeedToUpdate, solsNextStepsDocument, solsAdditionalInfo, primaryApplicantForenames, primaryApplicantSurname, primaryApplicantEmailAddress, primaryApplicantHasAlias, primaryApplicantIsApplying, solsPrimaryExecutorNotApplyingReason, otherExecutorExists, primaryApplicantAlias, primaryApplicantSameWillName, primaryApplicantAliasReason, primaryApplicantOtherReason, solsExecutorAliasNames, additionalExecutorsApplying, additionalExecutorsNotApplying, solsAdditionalExecutorList, deceasedAddress, deceasedAnyOtherNames, primaryApplicantAddress, solsDeceasedAliasNamesList, deceasedAliasNamesList, casePrinted, boEmailDocsReceivedNotificationRequested, boEmailGrantIssuedNotificationRequested, boEmailDocsReceivedNotification, boEmailGrantIssuedNotification, boCaseStopReasonList, boStopDetails, boDeceasedTitle, boDeceasedHonours, boWillMessage, boExecutorLimitation, boAdminClauseLimitation, boLimitationText, ihtReferenceNumber, ihtFormCompletedOnline, legalStatement, declaration, deceasedMarriedAfterWillOrCodicilDate, primaryApplicantPhoneNumber, boExaminationChecklistQ2, boExaminationChecklistQ1, boExaminationChecklistRequestQA, payments, applicationSubmittedDate, scannedDocuments, evidenceHandled, caseType, paperForm, languagePreferenceWelsh, primaryApplicantSecondPhoneNumber, primaryApplicantRelationshipToDeceased, paRelationshipToDeceasedOther, applicationFeePaperForm, feeForCopiesPaperForm, totalFeePaperForm, paperPaymentMethod, paymentReferenceNumberPaperform, entitledToApply, entitledToApplyOther, notifiedApplicants, foreignAsset, foreignAssetEstateValue, adopted, adoptiveRelatives, mentalCapacity, courtOfProtection, epaOrLpa, epaRegistered, domicilityCountry, ukEstate, domicilityIHTCert, solsEntrustingDoc, applicationGrounds, willDispose, englishWill, appointExec, appointExecByDuties, solsDomicilityCert, willDatedBeforeApril, deceasedEnterMarriageOrCP, deceasedMaritalStatus, willsOutsideOfUK, courtOfDecree, dateOfMarriageOrCP, dateOfDivorcedCPJudicially, willGiftUnderEighteen, applyingAsAnAttorney, attorneyOnBehalfOfNameAndAddress, spouseOrPartner, childrenSurvived, childrenOverEighteenSurvived, childrenUnderEighteenSurvived, childrenDied, childrenDiedOverEighteen, childrenDiedUnderEighteen, parentsExistSurvived, parentsExistOverEighteenSurvived, parentsExistUnderEighteenSurvived, wholeBloodNeicesAndNephews, wholeBloodNeicesAndNephewsOverEighteen, wholeBloodNeicesAndNephewsUnderEighteen, wholeBloodSiblingsDied, wholeBloodSiblingsDiedOverEighteen, wholeBloodSiblingsDiedUnderEighteen, wholeBloodSiblingsSurvived, wholeBloodSiblingsSurvivedOverEighteen, wholeBloodSiblingsSurvivedUnderEighteen, halfBloodSiblingsDied, halfBloodSiblingsDiedOverEighteen, halfBloodSiblingsDiedUnderEighteen, halfBloodSiblingsSurvived, halfBloodSiblingsSurvivedOverEighteen, halfBloodSiblingsSurvivedUnderEighteen, grandparentsDied, grandparentsDiedOverEighteen, grandparentsDiedUnderEighteen, halfBloodNeicesAndNephews, halfBloodNeicesAndNephewsOverEighteen, halfBloodNeicesAndNephewsUnderEighteen, grandChildrenSurvived, grandChildrenSurvivedOverEighteen, grandChildrenSurvivedUnderEighteen, wholeBloodUnclesAndAuntsDied, wholeBloodUnclesAndAuntsDiedOverEighteen, wholeBloodUnclesAndAuntsDiedUnderEighteen, wholeBloodUnclesAndAuntsSurvived, wholeBloodUnclesAndAuntsSurvivedOverEighteen, wholeBloodUnclesAndAuntsSurvivedUnderEighteen, halfBloodUnclesAndAuntsSurvived, halfBloodUnclesAndAuntsSurvivedOverEighteen, halfBloodUnclesAndAuntsSurvivedUnderEighteen, halfBloodUnclesAndAuntsDied, halfBloodUnclesAndAuntsDiedOverEighteen, halfBloodUnclesAndAuntsDiedUnderEighteen, halfBloodCousinsSurvived, halfBloodCousinsSurvivedOverEighteen, halfBloodCousinsSurvivedUnderEighteen, wholeBloodCousinsSurvived, wholeBloodCousinsSurvivedOverEighteen, wholeBloodCousinsSurvivedUnderEighteen, boSendToBulkPrint, boSendToBulkPrintRequested, grantIssuedDate, dateOfDeathType, legacySearchResultRows, recordId, legacyType, legacyCaseViewUrl, bulkPrintSendLetterId, bulkPrintPdfSize, bulkPrintId, boCaveatStopNotificationRequested, boCaveatStopNotification, boCaseStopCaveatId, boCaveatStopEmailNotificationRequested, boCaveatStopEmailNotification, boCaveatStopSendToBulkPrintRequested, boCaveatStopSendToBulkPrint, boEmailGrantReissuedNotificationRequested, boEmailGrantReissuedNotification, boGrantReissueSendToBulkPrint, boGrantReissueSendToBulkPrintRequested, orderNeeded, reissueReason, reissueDate, reissueReasonNotation, latestGrantReissueDate, deceasedDivorcedInEnglandOrWales, primaryApplicantAdoptionInEnglandOrWales, deceasedSpouseNotApplyingReason, deceasedOtherChildren, allDeceasedChildrenOverEighteen, anyDeceasedChildrenDieBeforeDeceased, anyDeceasedGrandChildrenUnderEighteen, deceasedAnyChildren, deceasedHasAssetsOutsideUK, solicitorIsMainApplicant, boStopDetailsDeclarationParagraph, boEmailRequestInfoNotificationRequested, boEmailRequestInfoNotification, boRequestInfoSendToBulkPrint, boRequestInfoSendToBulkPrintRequested, boAssembleLetterSendToBulkPrint, boAssembleLetterSendToBulkPrintRequested, executorsApplyingNotifications, probateSotDocumentsGenerated, categories, previewLink, paragraphDetails, bulkScanCaseReference, grantDelayedNotificationDate, grantStoppedDate, grantDelayedNotificationIdentified, grantDelayedNotificationSent, grantAwaitingDocumentationNotificationDate, grantAwaitingDocumentatioNotificationSent);
            responseCaseData.reprintDocument = reprintDocument;
            responseCaseData.reprintNumberOfCopies = reprintNumberOfCopies;
            return  responseCaseData;
        }

        public String toString() {
            return "ResponseCaseData.ResponseCaseDataBuilder(state=" + this.state + ", applicationType=" + this.applicationType + ", registryLocation=" + this.registryLocation + ", deceasedDateOfDeath=" + this.deceasedDateOfDeath + ", deceasedDateOfBirth=" + this.deceasedDateOfBirth + ", deceasedForenames=" + this.deceasedForenames + ", deceasedSurname=" + this.deceasedSurname + ", solsSolicitorFirmName=" + this.solsSolicitorFirmName + ", solsSolicitorAddress=" + this.solsSolicitorAddress + ", solsSolicitorEmail=" + this.solsSolicitorEmail + ", solsSolicitorPhoneNumber=" + this.solsSolicitorPhoneNumber + ", solsSOTName=" + this.solsSOTName + ", solsSOTForenames=" + this.solsSOTForenames + ", solsSOTSurname=" + this.solsSOTSurname + ", solsSOTJobTitle=" + this.solsSOTJobTitle + ", solsSolicitorAppReference=" + this.solsSolicitorAppReference + ", ihtFormId=" + this.ihtFormId + ", solsSolicitorIsExec=" + this.solsSolicitorIsExec + ", solsSolicitorIsMainApplicant=" + this.solsSolicitorIsMainApplicant + ", solsSolicitorIsApplying=" + this.solsSolicitorIsApplying + ", solsSolicitorNotApplyingReason=" + this.solsSolicitorNotApplyingReason + ", solsWillType=" + this.solsWillType + ", solsApplicantRelationshipToDeceased=" + this.solsApplicantRelationshipToDeceased + ", solsSpouseOrCivilRenouncing=" + this.solsSpouseOrCivilRenouncing + ", solsAdoptedEnglandOrWales=" + this.solsAdoptedEnglandOrWales + ", solsMinorityInterest=" + this.solsMinorityInterest + ", solsApplicantSiblings=" + this.solsApplicantSiblings + ", solsEntitledMinority=" + this.solsEntitledMinority + ", solsDiedOrNotApplying=" + this.solsDiedOrNotApplying + ", solsResiduary=" + this.solsResiduary + ", solsResiduaryType=" + this.solsResiduaryType + ", solsLifeInterest=" + this.solsLifeInterest + ", willExists=" + this.willExists + ", willAccessOriginal=" + this.willAccessOriginal + ", willHasCodicils=" + this.willHasCodicils + ", willNumberOfCodicils=" + this.willNumberOfCodicils + ", ihtNetValue=" + this.ihtNetValue + ", ihtGrossValue=" + this.ihtGrossValue + ", deceasedDomicileInEngWales=" + this.deceasedDomicileInEngWales + ", extraCopiesOfGrant=" + this.extraCopiesOfGrant + ", outsideUKGrantCopies=" + this.outsideUKGrantCopies + ", applicationFee=" + this.applicationFee + ", feeForUkCopies=" + this.feeForUkCopies + ", feeForNonUkCopies=" + this.feeForNonUkCopies + ", totalFee=" + this.totalFee + ", solsPaymentMethods=" + this.solsPaymentMethods + ", solsFeeAccountNumber=" + this.solsFeeAccountNumber + ", paymentReferenceNumber=" + this.paymentReferenceNumber + ", solsLegalStatementDocument=" + this.solsLegalStatementDocument + ", statementOfTruthDocument=" + this.statementOfTruthDocument + ", probateDocumentsGenerated=" + this.probateDocumentsGenerated + ", probateNotificationsGenerated=" + this.probateNotificationsGenerated + ", boDocumentsUploaded=" + this.boDocumentsUploaded + ", caseMatches=" + this.caseMatches + ", solsSOTNeedToUpdate=" + this.solsSOTNeedToUpdate + ", solsNextStepsDocument=" + this.solsNextStepsDocument + ", solsAdditionalInfo=" + this.solsAdditionalInfo + ", primaryApplicantForenames=" + this.primaryApplicantForenames + ", primaryApplicantSurname=" + this.primaryApplicantSurname + ", primaryApplicantEmailAddress=" + this.primaryApplicantEmailAddress + ", primaryApplicantHasAlias=" + this.primaryApplicantHasAlias + ", primaryApplicantIsApplying=" + this.primaryApplicantIsApplying + ", solsPrimaryExecutorNotApplyingReason=" + this.solsPrimaryExecutorNotApplyingReason + ", otherExecutorExists=" + this.otherExecutorExists + ", primaryApplicantAlias=" + this.primaryApplicantAlias + ", primaryApplicantSameWillName=" + this.primaryApplicantSameWillName + ", primaryApplicantAliasReason=" + this.primaryApplicantAliasReason + ", primaryApplicantOtherReason=" + this.primaryApplicantOtherReason + ", solsExecutorAliasNames=" + this.solsExecutorAliasNames + ", additionalExecutorsApplying=" + this.additionalExecutorsApplying + ", additionalExecutorsNotApplying=" + this.additionalExecutorsNotApplying + ", solsAdditionalExecutorList=" + this.solsAdditionalExecutorList + ", deceasedAddress=" + this.deceasedAddress + ", deceasedAnyOtherNames=" + this.deceasedAnyOtherNames + ", primaryApplicantAddress=" + this.primaryApplicantAddress + ", solsDeceasedAliasNamesList=" + this.solsDeceasedAliasNamesList + ", deceasedAliasNamesList=" + this.deceasedAliasNamesList + ", casePrinted=" + this.casePrinted + ", boEmailDocsReceivedNotificationRequested=" + this.boEmailDocsReceivedNotificationRequested + ", boEmailGrantIssuedNotificationRequested=" + this.boEmailGrantIssuedNotificationRequested + ", boEmailDocsReceivedNotification=" + this.boEmailDocsReceivedNotification + ", boEmailGrantIssuedNotification=" + this.boEmailGrantIssuedNotification + ", boCaseStopReasonList=" + this.boCaseStopReasonList + ", boStopDetails=" + this.boStopDetails + ", boDeceasedTitle=" + this.boDeceasedTitle + ", boDeceasedHonours=" + this.boDeceasedHonours + ", boWillMessage=" + this.boWillMessage + ", boExecutorLimitation=" + this.boExecutorLimitation + ", boAdminClauseLimitation=" + this.boAdminClauseLimitation + ", boLimitationText=" + this.boLimitationText + ", ihtReferenceNumber=" + this.ihtReferenceNumber + ", ihtFormCompletedOnline=" + this.ihtFormCompletedOnline + ", legalStatement=" + this.legalStatement + ", declaration=" + this.declaration + ", deceasedMarriedAfterWillOrCodicilDate=" + this.deceasedMarriedAfterWillOrCodicilDate + ", primaryApplicantPhoneNumber=" + this.primaryApplicantPhoneNumber + ", boExaminationChecklistQ2=" + this.boExaminationChecklistQ2 + ", boExaminationChecklistQ1=" + this.boExaminationChecklistQ1 + ", boExaminationChecklistRequestQA=" + this.boExaminationChecklistRequestQA + ", payments=" + this.payments + ", applicationSubmittedDate=" + this.applicationSubmittedDate + ", scannedDocuments=" + this.scannedDocuments + ", evidenceHandled=" + this.evidenceHandled + ", caseType=" + this.caseType + ", paperForm=" + this.paperForm + ", languagePreferenceWelsh=" + this.languagePreferenceWelsh + ", primaryApplicantSecondPhoneNumber=" + this.primaryApplicantSecondPhoneNumber + ", primaryApplicantRelationshipToDeceased=" + this.primaryApplicantRelationshipToDeceased + ", paRelationshipToDeceasedOther=" + this.paRelationshipToDeceasedOther + ", applicationFeePaperForm=" + this.applicationFeePaperForm + ", feeForCopiesPaperForm=" + this.feeForCopiesPaperForm + ", totalFeePaperForm=" + this.totalFeePaperForm + ", paperPaymentMethod=" + this.paperPaymentMethod + ", paymentReferenceNumberPaperform=" + this.paymentReferenceNumberPaperform + ", entitledToApply=" + this.entitledToApply + ", entitledToApplyOther=" + this.entitledToApplyOther + ", notifiedApplicants=" + this.notifiedApplicants + ", foreignAsset=" + this.foreignAsset + ", foreignAssetEstateValue=" + this.foreignAssetEstateValue + ", adopted=" + this.adopted + ", adoptiveRelatives=" + this.adoptiveRelatives + ", mentalCapacity=" + this.mentalCapacity + ", courtOfProtection=" + this.courtOfProtection + ", epaOrLpa=" + this.epaOrLpa + ", epaRegistered=" + this.epaRegistered + ", domicilityCountry=" + this.domicilityCountry + ", ukEstate=" + this.ukEstate + ", domicilityIHTCert=" + this.domicilityIHTCert + ", solsEntrustingDoc=" + this.solsEntrustingDoc + ", applicationGrounds=" + this.applicationGrounds + ", willDispose=" + this.willDispose + ", englishWill=" + this.englishWill + ", appointExec=" + this.appointExec + ", appointExecByDuties=" + this.appointExecByDuties + ", solsDomicilityCert=" + this.solsDomicilityCert + ", willDatedBeforeApril=" + this.willDatedBeforeApril + ", deceasedEnterMarriageOrCP=" + this.deceasedEnterMarriageOrCP + ", deceasedMaritalStatus=" + this.deceasedMaritalStatus + ", willsOutsideOfUK=" + this.willsOutsideOfUK + ", courtOfDecree=" + this.courtOfDecree + ", dateOfMarriageOrCP=" + this.dateOfMarriageOrCP + ", dateOfDivorcedCPJudicially=" + this.dateOfDivorcedCPJudicially + ", willGiftUnderEighteen=" + this.willGiftUnderEighteen + ", applyingAsAnAttorney=" + this.applyingAsAnAttorney + ", attorneyOnBehalfOfNameAndAddress=" + this.attorneyOnBehalfOfNameAndAddress + ", spouseOrPartner=" + this.spouseOrPartner + ", childrenSurvived=" + this.childrenSurvived + ", childrenOverEighteenSurvived=" + this.childrenOverEighteenSurvived + ", childrenUnderEighteenSurvived=" + this.childrenUnderEighteenSurvived + ", childrenDied=" + this.childrenDied + ", childrenDiedOverEighteen=" + this.childrenDiedOverEighteen + ", childrenDiedUnderEighteen=" + this.childrenDiedUnderEighteen + ", parentsExistSurvived=" + this.parentsExistSurvived + ", parentsExistOverEighteenSurvived=" + this.parentsExistOverEighteenSurvived + ", parentsExistUnderEighteenSurvived=" + this.parentsExistUnderEighteenSurvived + ", wholeBloodNeicesAndNephews=" + this.wholeBloodNeicesAndNephews + ", wholeBloodNeicesAndNephewsOverEighteen=" + this.wholeBloodNeicesAndNephewsOverEighteen + ", wholeBloodNeicesAndNephewsUnderEighteen=" + this.wholeBloodNeicesAndNephewsUnderEighteen + ", wholeBloodSiblingsDied=" + this.wholeBloodSiblingsDied + ", wholeBloodSiblingsDiedOverEighteen=" + this.wholeBloodSiblingsDiedOverEighteen + ", wholeBloodSiblingsDiedUnderEighteen=" + this.wholeBloodSiblingsDiedUnderEighteen + ", wholeBloodSiblingsSurvived=" + this.wholeBloodSiblingsSurvived + ", wholeBloodSiblingsSurvivedOverEighteen=" + this.wholeBloodSiblingsSurvivedOverEighteen + ", wholeBloodSiblingsSurvivedUnderEighteen=" + this.wholeBloodSiblingsSurvivedUnderEighteen + ", halfBloodSiblingsDied=" + this.halfBloodSiblingsDied + ", halfBloodSiblingsDiedOverEighteen=" + this.halfBloodSiblingsDiedOverEighteen + ", halfBloodSiblingsDiedUnderEighteen=" + this.halfBloodSiblingsDiedUnderEighteen + ", halfBloodSiblingsSurvived=" + this.halfBloodSiblingsSurvived + ", halfBloodSiblingsSurvivedOverEighteen=" + this.halfBloodSiblingsSurvivedOverEighteen + ", halfBloodSiblingsSurvivedUnderEighteen=" + this.halfBloodSiblingsSurvivedUnderEighteen + ", grandparentsDied=" + this.grandparentsDied + ", grandparentsDiedOverEighteen=" + this.grandparentsDiedOverEighteen + ", grandparentsDiedUnderEighteen=" + this.grandparentsDiedUnderEighteen + ", halfBloodNeicesAndNephews=" + this.halfBloodNeicesAndNephews + ", halfBloodNeicesAndNephewsOverEighteen=" + this.halfBloodNeicesAndNephewsOverEighteen + ", halfBloodNeicesAndNephewsUnderEighteen=" + this.halfBloodNeicesAndNephewsUnderEighteen + ", grandChildrenSurvived=" + this.grandChildrenSurvived + ", grandChildrenSurvivedOverEighteen=" + this.grandChildrenSurvivedOverEighteen + ", grandChildrenSurvivedUnderEighteen=" + this.grandChildrenSurvivedUnderEighteen + ", wholeBloodUnclesAndAuntsDied=" + this.wholeBloodUnclesAndAuntsDied + ", wholeBloodUnclesAndAuntsDiedOverEighteen=" + this.wholeBloodUnclesAndAuntsDiedOverEighteen + ", wholeBloodUnclesAndAuntsDiedUnderEighteen=" + this.wholeBloodUnclesAndAuntsDiedUnderEighteen + ", wholeBloodUnclesAndAuntsSurvived=" + this.wholeBloodUnclesAndAuntsSurvived + ", wholeBloodUnclesAndAuntsSurvivedOverEighteen=" + this.wholeBloodUnclesAndAuntsSurvivedOverEighteen + ", wholeBloodUnclesAndAuntsSurvivedUnderEighteen=" + this.wholeBloodUnclesAndAuntsSurvivedUnderEighteen + ", halfBloodUnclesAndAuntsSurvived=" + this.halfBloodUnclesAndAuntsSurvived + ", halfBloodUnclesAndAuntsSurvivedOverEighteen=" + this.halfBloodUnclesAndAuntsSurvivedOverEighteen + ", halfBloodUnclesAndAuntsSurvivedUnderEighteen=" + this.halfBloodUnclesAndAuntsSurvivedUnderEighteen + ", halfBloodUnclesAndAuntsDied=" + this.halfBloodUnclesAndAuntsDied + ", halfBloodUnclesAndAuntsDiedOverEighteen=" + this.halfBloodUnclesAndAuntsDiedOverEighteen + ", halfBloodUnclesAndAuntsDiedUnderEighteen=" + this.halfBloodUnclesAndAuntsDiedUnderEighteen + ", halfBloodCousinsSurvived=" + this.halfBloodCousinsSurvived + ", halfBloodCousinsSurvivedOverEighteen=" + this.halfBloodCousinsSurvivedOverEighteen + ", halfBloodCousinsSurvivedUnderEighteen=" + this.halfBloodCousinsSurvivedUnderEighteen + ", wholeBloodCousinsSurvived=" + this.wholeBloodCousinsSurvived + ", wholeBloodCousinsSurvivedOverEighteen=" + this.wholeBloodCousinsSurvivedOverEighteen + ", wholeBloodCousinsSurvivedUnderEighteen=" + this.wholeBloodCousinsSurvivedUnderEighteen + ", boSendToBulkPrint=" + this.boSendToBulkPrint + ", boSendToBulkPrintRequested=" + this.boSendToBulkPrintRequested + ", grantIssuedDate=" + this.grantIssuedDate + ", dateOfDeathType=" + this.dateOfDeathType + ", legacySearchResultRows=" + this.legacySearchResultRows + ", recordId=" + this.recordId + ", legacyType=" + this.legacyType + ", legacyCaseViewUrl=" + this.legacyCaseViewUrl + ", bulkPrintSendLetterId=" + this.bulkPrintSendLetterId + ", bulkPrintPdfSize=" + this.bulkPrintPdfSize + ", bulkPrintId=" + this.bulkPrintId + ", boCaveatStopNotificationRequested=" + this.boCaveatStopNotificationRequested + ", boCaveatStopNotification=" + this.boCaveatStopNotification + ", boCaseStopCaveatId=" + this.boCaseStopCaveatId + ", boCaveatStopEmailNotificationRequested=" + this.boCaveatStopEmailNotificationRequested + ", boCaveatStopEmailNotification=" + this.boCaveatStopEmailNotification + ", boCaveatStopSendToBulkPrintRequested=" + this.boCaveatStopSendToBulkPrintRequested + ", boCaveatStopSendToBulkPrint=" + this.boCaveatStopSendToBulkPrint + ", boEmailGrantReissuedNotificationRequested=" + this.boEmailGrantReissuedNotificationRequested + ", boEmailGrantReissuedNotification=" + this.boEmailGrantReissuedNotification + ", boGrantReissueSendToBulkPrint=" + this.boGrantReissueSendToBulkPrint + ", boGrantReissueSendToBulkPrintRequested=" + this.boGrantReissueSendToBulkPrintRequested + ", orderNeeded=" + this.orderNeeded + ", reissueReason=" + this.reissueReason + ", reissueDate=" + this.reissueDate + ", reissueReasonNotation=" + this.reissueReasonNotation + ", latestGrantReissueDate=" + this.latestGrantReissueDate + ", deceasedDivorcedInEnglandOrWales=" + this.deceasedDivorcedInEnglandOrWales + ", primaryApplicantAdoptionInEnglandOrWales=" + this.primaryApplicantAdoptionInEnglandOrWales + ", deceasedSpouseNotApplyingReason=" + this.deceasedSpouseNotApplyingReason + ", deceasedOtherChildren=" + this.deceasedOtherChildren + ", allDeceasedChildrenOverEighteen=" + this.allDeceasedChildrenOverEighteen + ", anyDeceasedChildrenDieBeforeDeceased=" + this.anyDeceasedChildrenDieBeforeDeceased + ", anyDeceasedGrandChildrenUnderEighteen=" + this.anyDeceasedGrandChildrenUnderEighteen + ", deceasedAnyChildren=" + this.deceasedAnyChildren + ", deceasedHasAssetsOutsideUK=" + this.deceasedHasAssetsOutsideUK + ", solicitorIsMainApplicant=" + this.solicitorIsMainApplicant + ", boStopDetailsDeclarationParagraph=" + this.boStopDetailsDeclarationParagraph + ", boEmailRequestInfoNotificationRequested=" + this.boEmailRequestInfoNotificationRequested + ", boEmailRequestInfoNotification=" + this.boEmailRequestInfoNotification + ", boRequestInfoSendToBulkPrint=" + this.boRequestInfoSendToBulkPrint + ", boRequestInfoSendToBulkPrintRequested=" + this.boRequestInfoSendToBulkPrintRequested + ", boAssembleLetterSendToBulkPrint=" + this.boAssembleLetterSendToBulkPrint + ", boAssembleLetterSendToBulkPrintRequested=" + this.boAssembleLetterSendToBulkPrintRequested + ", executorsApplyingNotifications=" + this.executorsApplyingNotifications + ", probateSotDocumentsGenerated=" + this.probateSotDocumentsGenerated + ", categories=" + this.categories + ", previewLink=" + this.previewLink + ", paragraphDetails=" + this.paragraphDetails + ", bulkScanCaseReference=" + this.bulkScanCaseReference + ", grantDelayedNotificationDate=" + this.grantDelayedNotificationDate + ", grantStoppedDate=" + this.grantStoppedDate + ", grantDelayedNotificationIdentified=" + this.grantDelayedNotificationIdentified + ", grantDelayedNotificationSent=" + this.grantDelayedNotificationSent + ", grantAwaitingDocumentationNotificationDate=" + this.grantAwaitingDocumentationNotificationDate + ", grantAwaitingDocumentatioNotificationSent=" + this.grantAwaitingDocumentatioNotificationSent + ")";
        }
    }
}
