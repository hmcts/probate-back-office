...
public class BusinessValidationController {
    ...
    @PostMapping(path = "/sols-validate", consumes = APPLICATION_JSON_VALUE)
    ...
    @PostMapping(path = "/sols-validate-probate", consumes = APPLICATION_JSON_VALUE)
    ...
    @PostMapping(path = "/sols-validate-intestacy", consumes = APPLICATION_JSON_VALUE)
    ...
    @PostMapping(path = "/sols-validate-admon", consumes = APPLICATION_JSON_VALUE)
    ...
    @PostMapping(path = "/validateCaseDetails", consumes = APPLICATION_JSON_VALUE)
    ...
    @PostMapping(path = "/validateCheckListDetails", consumes = APPLICATION_JSON_VALUE)
    ...
    @PostMapping(path = "/case-stopped", consumes = APPLICATION_JSON_VALUE)
    ...
    @PostMapping(path = "/resolveStop", consumes = APPLICATION_JSON_VALUE)
    ...
    @PostMapping(path = "/redeclarationComplete", consumes = APPLICATION_JSON_VALUE, produces = {APPLICATION_JSON_VALUE})
    ...
    @PostMapping(path = "/default-sols-next-steps", consumes = APPLICATION_JSON_VALUE, produces = {APPLICATION_JSON_VALUE})
