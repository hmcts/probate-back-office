...
public class DocumentController {
    ...
    public ResponseEntity<CallbackResponse> previewLetter(
        ...
        Document letterPreview = documentGeneratorService.generateLetter(callbackRequest, false, DocumentType.ASSEMBLED_LETTER);
    ...
    public ResponseEntity<CallbackResponse> generateLetter(
        ...
        Document letter = documentGeneratorService.generateLetter(callbackRequest, true, DocumentType.ASSEMBLED_LETTER);
    ...
    public ResponseEntity<CallbackResponse> generateGrant(
        ...
        if (!caseDetails.getData().isLanguagePreferenceWelsh() && grantState.apply(caseData.getCaseType())== GRANT_ISSUED) {
            letterOfGrantIssuedState = documentGeneratorService.generateLetter(callbackRequest, true,
