...
public class ClientDataException extends RuntimeException {
    ...
    public ClientDataException(final String message, final Errors errors) {
        super(message);
    ...
    public ClientDataException(final String message, final List<FieldErrorResponse> errors) {
        super(message);
        this.errors = errors;
    }
