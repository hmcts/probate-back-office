...
SERVICE_TOKEN=$(./bin/utils/idam-lease-service-token.sh ccd_gw \
  $(docker run --rm hmctsprod.azurecr.io/imported/toolbelt/oathtool --totp -b ${S2S_SECRET:-AAAAAAAAAAAAAAAC}))
