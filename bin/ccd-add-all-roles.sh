...
(${binFolder}/idam-create-caseworker.sh caseworker,caseworker-probate,caseworker-probate-rparobot ProbateRpaRobot@gmail.com)
...
(${binFolder}/ccd-add-role.sh hmcts-legal-operations)
