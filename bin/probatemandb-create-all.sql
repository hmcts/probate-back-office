--DROP TABLE STANDING_SEARCHES_FLAT;
--DROP TABLE WILLS_FLAT;
--DROP TABLE CAVEATS_FLAT;
--DROP TABLE GRANT_APPLICATIONS_FLAT;

--update STANDING_SEARCHES_FLAT set LAST_MODIFIED = now();
--update WILLS_FLAT set LAST_MODIFIED = now();
--update CAVEATS_FLAT set LAST_MODIFIED = now();
--update GRANT_APPLICATIONS_FLAT set LAST_MODIFIED = now();
...
CREATE INDEX IDX_LAST_MODIFIED_SS ON STANDING_SEARCHES_FLAT(LAST_MODIFIED);
...
CREATE INDEX IDX_LAST_MODIFIED_WILL ON WILLS_FLAT(LAST_MODIFIED);
...
CREATE INDEX IDX_LAST_MODIFIED_CAV ON CAVEATS_FLAT(LAST_MODIFIED);
...
CREATE INDEX IDX_LAST_MODIFIED_GOR ON GRANT_APPLICATIONS_FLAT(LAST_MODIFIED);
...
(
ID, SS_NUMBER, PROBATE_NUMBER, PROBATE_VERSION, DECEASED_ID, DECEASED_FORENAMES, DECEASED_SURNAME, DATE_OF_BIRTH, DATE_OF_DEATH1, DATE_OF_DEATH2, CCD_CASE_NO,
...
VALUES (
nextval('STANDING_SEARCHES_FLAT_SEQ'), 'SS-01','PRO-01', 1, 1, 'DeceasedFN', 'DeceasedSN', '01/01/1900', '01/01/2018', '02/02/2018', null,
'DeadAddL1, DeadAddL2, DeadAddL3, DeadCity, DeadCountry, DeadPC','AppAddL1, AppAddL2, AppAddL3, AppCity, AppCountry, AppPC',
1, 'SSFN', 'SSSN', 'Sir', 'Mr','01/01/2018', '01/01/2018', '01/01/2018', '01/01/2018', 'SS-Text', 'N', 'DeceasedAlias', NOW()
);
...
nextval('WILLS_FLAT_SEQ'), 'RK-1', 'PRO-01', 1, 1, 'DeceasedFN', 'DeceasedSN', '01/01/1900', '01/01/2018', '02/02/2018', 'DeceasedAlias',
'RK-Text', null, 'N', NOW()
);
