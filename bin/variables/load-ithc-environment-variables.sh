...
echo "export IDAM_API_BASE_URL=https://idam-web-public.ithc.platform.hmcts.net"
...
echo "export CCD_DEF_CASE_SERVICE_BASE_URL=http://probate-back-office-ithc.service.core-compute-ithc.internal"
