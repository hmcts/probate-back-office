...
echo "USER_AUTH_PROVIDER_OAUTH2_URL=https://idam-web-public.aat.platform.hmcts.net" >> .aat-env
...
echo "IDAM_SERVICE_HOST=https://idam-web-public.aat.platform.hmcts.net" >> .aat-env
...
echo "IDAM_API_URL=https://idam-web-public.aat.platform.hmcts.net" >> .aat-env
