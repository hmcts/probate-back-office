...
public class ExceptionRecordGrantOfRepresentationMapperImpl implements ExceptionRecordGrantOfRepresentationMapper {
    ...
    public GrantOfRepresentationData toCcdData(ExceptionRecordOCRFields ocrFields, GrantType grantType) {
        ...
        if ( ocrFields != null ) {
            ...
            if ( ocrFields.getIhtEstateNetValue() != null ) {
                grantOfRepresentationData.setIhtEstateNetValue( oCRFieldIhtMoneyMapper.poundsToPennies( ocrFields.getIhtEstateNetValue() ) );
            }
            ...
            if ( ocrFields.getIhtEstateGrossValue() != null ) {
                grantOfRepresentationData.setIhtEstateGrossValue( oCRFieldIhtMoneyMapper.poundsToPennies( ocrFields.getIhtEstateGrossValue() ) );
            }
            ...
            if ( ocrFields.getIhtUnusedAllowanceClaimed() != null ) {
                grantOfRepresentationData.setIhtUnusedAllowanceClaimed( oCRFieldYesOrNoMapper.toYesOrNo( ocrFields.getIhtUnusedAllowanceClaimed() ) );
            }
            ...
            if ( ocrFields.getIhtEstateNetQualifyingValue() != null ) {
                grantOfRepresentationData.setIhtEstateNetQualifyingValue( oCRFieldIhtMoneyMapper.poundsToPennies( ocrFields.getIhtEstateNetQualifyingValue() ) );
            }
            ...
            grantOfRepresentationData.setDeceasedHadLateSpouseOrCivilPartner( oCRFieldDeceasedHadLateSpouseOrCivilPartnerMapper.decasedHadLateSpouseOrCivilPartner( ocrFields ) );
